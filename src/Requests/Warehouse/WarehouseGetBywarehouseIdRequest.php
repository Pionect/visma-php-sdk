...
class WarehouseGetBywarehouseIdRequest extends Request
{
    ...
    public function createDtoFromResponse(Response $response): WarehouseDto
    {
        return WarehouseDto::from($response->json());
    }

    public function resolveEndpoint(): string
    {
        return "/v1/warehouse/{$this->warehouseId}";
    }

    /**
     * @param  string  $warehouseId  Identifies the Warehouse
