...
namespace Pionect\VismaSdk\Requests\Organization;
 ...
 *
 * Response Message has StatusCode No Content if PUT operation succeed. <br></br>
 *             Response
 * Message has StatusCode BadRequest if PUT operation failed. <br></br>
 *             The response
 * headers include an ETag after a successful PUT operation.
 */
class OrganizationPutBankSettingsForOrganizationByorganizationNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/organization/{$this->organizationNumber}/BankSettings";
    }

    /**
     * @param  string  $organizationNumber  organization number to update
     * @param  null|\Pionect\VismaSdk\Dto\BankSettingsUpdateDto|array|null  $data  Request data
    ...
    public function __construct(
        ...
        protected BankSettingsUpdateDto|array|null $data = null,
