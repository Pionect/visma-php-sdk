 ...
 *
 * Data for a single expense claim <br></br>
...
class ExpenseClaimGetExpenseClaimByexpenseClaimNbrRequest extends Request
{
    ...
    public function createDtoFromResponse(Response $response): ExpenseClaimDto
    {
    ...
    /**
     * @param  string  $expenseClaimNbr  Identifies the expense claim
