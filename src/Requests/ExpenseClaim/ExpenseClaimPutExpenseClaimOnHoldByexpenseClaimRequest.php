...
use Pionect\VismaSdk\Dto\PutExpenseClaimOnHoldActionResultDto;
...
/**
 * ExpenseClaim_PutExpenseClaimOnHoldByexpenseClaim
 *
 ...
 */
class ExpenseClaimPutExpenseClaimOnHoldByexpenseClaimRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/expenseClaim/{$this->expenseClaimId}/action/hold";
    }

    /**
     * @param  string  $expenseClaimId  Reference number of the ExpenseClaim to be put on hold
