...
/**
 * ExpenseClaim_PutByexpenseClaimNbr
 *
 ...
 */
class ExpenseClaimPutByexpenseClaimNbrRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/expenseClaim/{$this->expenseClaimNbr}";
    }

    /**
     * @param  string  $expenseClaimNbr  Identifies the ExpenseClaim to update
     * @param  null|\Pionect\VismaSdk\Dto\ExpenseClaimUpdateDto|array|null  $data  Request data
    ...
    public function __construct(
        protected string $expenseClaimNbr,
        protected ExpenseClaimUpdateDto|array|null $data = null,
