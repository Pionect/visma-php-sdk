...
use Pionect\VismaSdk\Dto\SubmitExpenseClaimActionResultDto;
...
/**
 * ExpenseClaim_SubmitExpenseClaimByexpenseClaim
 *
 ...
 */
class ExpenseClaimSubmitExpenseClaimByexpenseClaimRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/expenseClaim/{$this->expenseClaimId}/action/submit";
    }

    /**
     * @param  string  $expenseClaimId  Reference number of the Expense Claim to be submitted
