...
/**
 * ExpenseClaim_SendExpenseClaimToApprovalByexpenseClaim
 *
 ...
 */
class ExpenseClaimSendExpenseClaimToApprovalByexpenseClaimRequest extends Request implements HasBody
{
    use HasJsonBody;

    protected $model = SendExpenseClaimToApprovalActionResultDto::class;
