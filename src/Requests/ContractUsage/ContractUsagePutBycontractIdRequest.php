 ...
 */
class ContractUsagePutBycontractIdRequest extends Request
{
    protected Method $method = Method::PUT;

    public function resolveEndpoint(): string
    {
        return "/v1/contractUsage/{$this->contractIdId}";
    }

    /**
     * @param  string  $contractIdId  Identifies the Contract Usage to update
