...
/**
 * CustomerInvoice_UpdateByinvoiceNumber
 *
 ...
 */
class CustomerInvoiceUpdateByinvoiceNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/customerinvoice/{$this->invoiceNumber}";
    }

    /**
     * @param  string  $invoiceNumber  Identifies the Invoice to update
     * @param  null|\Pionect\VismaSdk\Dto\CustomerInvoiceUpdateDto|array|null  $data  Request data
    ...
    public function __construct(
        ...
        protected CustomerInvoiceUpdateDto|array|null $data = null,
