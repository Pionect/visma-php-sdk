 ...
 * calling with 'erp-api-background' HTTP header. <br></br>
 * The response headers include an ETag for
 * the returned credit note after a successful POST operation.
 */
class CustomerInvoiceReverseInvoiceAndApplyToNoteByinvoiceNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/customerinvoice/{$this->invoiceNumber}/action/reverseandapplytonote";
    }

    /**
     * @param  string  $invoiceNumber  Reference number of the released invoice to be reversed and applied to Memo
     * @param  null|\Pionect\VismaSdk\Dto\ReverseInvoiceActionDto|array|null  $data  Request data
    ...
    public function __construct(
        ...
        protected ReverseInvoiceActionDto|array|null $data = null,
