 ...
 * operation.
 */
class CustomerInvoiceGetByinvoiceNumberRequest extends Request
{
    protected Method $method = Method::GET;

    public function createDtoFromResponse(Response $response): CustomerInvoiceDto
    {
        return CustomerInvoiceDto::from($response->json());
    }
