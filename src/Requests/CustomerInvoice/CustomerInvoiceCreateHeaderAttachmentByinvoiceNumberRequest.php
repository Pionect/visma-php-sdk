...
/**
 * CustomerInvoice_CreateHeaderAttachmentByinvoiceNumber
 *
 ...
 */
class CustomerInvoiceCreateHeaderAttachmentByinvoiceNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
