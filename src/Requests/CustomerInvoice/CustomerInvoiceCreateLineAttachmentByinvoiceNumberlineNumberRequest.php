...
/**
 * CustomerInvoice_CreateLineAttachmentByinvoiceNumberlineNumber
 *
 ...
 * against resource current version when calling with 'erp-api-background' HTTP header. <br></br>
 * The
 * response headers include an ETag after a successful POST operation.
 */
class CustomerInvoiceCreateLineAttachmentByinvoiceNumberlineNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
