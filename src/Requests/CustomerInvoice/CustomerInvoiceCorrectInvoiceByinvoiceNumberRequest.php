 ...
 * <br></br>
 * In this endpoint, If-Match can be checked against resource current version when calling
 * with 'erp-api-background' HTTP header.<br></br>
 * The response headers include an ETag for the new
 * corrected invoice after a successful POST operation.
 */
class CustomerInvoiceCorrectInvoiceByinvoiceNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
