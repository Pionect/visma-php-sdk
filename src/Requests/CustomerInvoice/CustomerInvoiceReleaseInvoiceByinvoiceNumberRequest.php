 ...
 */
class CustomerInvoiceReleaseInvoiceByinvoiceNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/customerinvoice/{$this->invoiceNumberId}/action/release";
    }

    /**
     * @param  string  $invoiceNumberId  Reference number of the invoice to be released
