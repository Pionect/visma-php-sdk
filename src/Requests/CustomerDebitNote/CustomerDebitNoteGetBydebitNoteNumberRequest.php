 ...
 *
 * Data for Customer Debit Note <br></br>
...
class CustomerDebitNoteGetBydebitNoteNumberRequest extends Request
{
    ...
    public function createDtoFromResponse(Response $response): CustomerDebitNoteDto
    {
        return CustomerDebitNoteDto::from($response->json());
    }
