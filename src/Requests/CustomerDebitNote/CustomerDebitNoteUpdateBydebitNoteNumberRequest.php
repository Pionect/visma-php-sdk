 ...
 */
class CustomerDebitNoteUpdateBydebitNoteNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/customerDebitNote/{$this->debitNoteNumber}";
    }

    /**
     * @param  string  $debitNoteNumber  Identifies the Debit Note to update
