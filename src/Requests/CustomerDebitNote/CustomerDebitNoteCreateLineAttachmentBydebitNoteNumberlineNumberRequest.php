...
/**
 * CustomerDebitNote_CreateLineAttachmentBydebitNoteNumberlineNumber
 *
 ...
 */
class CustomerDebitNoteCreateLineAttachmentBydebitNoteNumberlineNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
