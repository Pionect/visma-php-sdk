...
/**
 * CustomerDebitNote_ReleaseDocumentBydebitNoteNumber
 *
 ...
 */
class CustomerDebitNoteReleaseDocumentBydebitNoteNumberRequest extends Request implements HasBody
{
    use HasJsonBody;

    protected $model = ReleaseCustomerDebitNoteActionResultDto::class;
    ...
    {
        return "/v1/customerDebitNote/{$this->debitNoteNumberId}/action/release";
    }

    /**
     * @param  string  $debitNoteNumberId  Reference number of the debit note to be released
