...
/**
 * CustomerDebitNote_CreateHeaderAttachmentBydebitNoteNumber
 *
 ...
 */
class CustomerDebitNoteCreateHeaderAttachmentBydebitNoteNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/customerDebitNote/{$this->debitNoteNumberId}/attachment";
    }
