...
class CustomerDebitNoteSendToAutoInvoiceBydebitNoteNumberRequest extends Request implements HasBody
{
    ...
    {
        return "/v1/customerDebitNote/{$this->debitNoteNumber}/action/sendToAutoInvoice";
    }

    /**
     * @param  string  $debitNoteNumber  Reference number of the debit note to be send to AutoInvoice
