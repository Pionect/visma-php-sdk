...
/**
 * CustomerDebitNote_SendToAutoInvoiceBydebitNoteNumber
 *
...
class CustomerDebitNoteSendToAutoInvoiceBydebitNoteNumberRequest extends Request implements HasBody
{
    ...
    {
        return "/v1/customerDebitNote/{$this->debitNoteNumberId}/action/sendToAutoInvoice";
    }

    /**
     * @param  string  $debitNoteNumberId  Reference number of the debit note to be send to AutoInvoice
