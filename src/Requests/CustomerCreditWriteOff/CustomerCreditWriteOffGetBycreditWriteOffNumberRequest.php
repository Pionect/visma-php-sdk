 ...
 *
 * Data for Customer Credit WriteOff <br></br>
...
class CustomerCreditWriteOffGetBycreditWriteOffNumberRequest extends Request
{
    ...
    {
        return "/v1/customerCreditWriteOff/{$this->creditWriteOffNumberId}";
    }

    /**
     * @param  string  $creditWriteOffNumberId  Identifies the Customer Credit WriteOff
    ...
    public function __construct(
        protected string $creditWriteOffNumberId,
