...
class CustomerCreditWriteOffGetBycreditWriteOffNumberRequest extends Request
{
    ...
    {
        return "/v1/customerCreditWriteOff/{$this->creditWriteOffNumber}";
    }

    /**
     * @param  string  $creditWriteOffNumber  Identifies the Customer Credit WriteOff
    ...
    public function __construct(
        protected string $creditWriteOffNumber,
