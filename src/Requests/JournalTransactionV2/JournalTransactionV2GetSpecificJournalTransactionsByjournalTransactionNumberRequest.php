 ...
 *
 * Data for Journal Transaction<br></br>
...
class JournalTransactionV2GetSpecificJournalTransactionsByjournalTransactionNumberRequest extends Request
{
    ...
    public function createDtoFromResponse(Response $response): JournalTransactionDto
    {
        return JournalTransactionDto::from($response->json());
    }
    ...
    /**
     * @param  string  $journalTransactionNumber  Identifies the Journal Transaction
