 ...
 *             Response
 * Message has StatusCode BadRequest if POST operation failed
 */
class JournalTransactionV2AddHeaderAttachmentBymodulejournalTransactionNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
