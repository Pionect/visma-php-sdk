...
/**
 * JournalTransactionV2_PutByjournalTransactionNumber
 *
 * Response Message has StatusCode NoContent if PUT operation succeed<br></br>
 *             The
 * response headers include an ETag after a successful PUT operation.<br></br>
 *             Response
...
class JournalTransactionV2PutByjournalTransactionNumberRequest extends VismaMutationRequest
{
    ...
    {
        return "/v2/journaltransaction/{$this->journalTransactionNumber}";
    }

    /**
     * @param  string  $journalTransactionNumber  Identifies the Journal Transaction to update
