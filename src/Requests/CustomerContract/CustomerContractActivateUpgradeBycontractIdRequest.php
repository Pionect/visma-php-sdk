 ...
 */
class CustomerContractActivateUpgradeBycontractIdRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/customerContract/{$this->contractIdId}/action/activateUpgrade";
    }

    /**
     * @param  string  $contractIdId  Reference number of the customer contract to be activated
