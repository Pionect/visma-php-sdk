...
/**
 * CustomerContract_SetupAndActivateContractBycontractId
 *
 * Response Message has StatusCode BadRequest or InternalServerError if POST operation failed
 */
class CustomerContractSetupAndActivateContractBycontractIdRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/customerContract/{$this->contractIdId}/action/setupAndActivateContract";
    }

    /**
     * @param  string  $contractIdId  Reference number of the customer contract to be setup and activated
