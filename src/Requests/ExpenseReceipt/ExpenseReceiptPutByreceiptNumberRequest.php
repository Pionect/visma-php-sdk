...
namespace Pionect\VismaSdk\Requests\ExpenseReceipt;
...
/**
 * ExpenseReceipt_PutByreceiptNumber
 *
 ...
 */
class ExpenseReceiptPutByreceiptNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/expenseReceipt/{$this->receiptNumber}";
    }

    /**
     * @param  string  $receiptNumber  Identifies the ExpenseReceipt
     * @param  null|\Pionect\VismaSdk\Dto\ExpenseReceiptUpdateDto|array|null  $data  Request data
    ...
    public function __construct(
        ...
        protected ExpenseReceiptUpdateDto|array|null $data = null,
