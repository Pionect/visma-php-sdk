...
/**
 * ExpenseReceipt_CreateAttachmentByreceiptNumber
 *
 ...
 */
class ExpenseReceiptCreateAttachmentByreceiptNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/expenseReceipt/{$this->receiptNumberId}/attachment";
    }

    /**
     * @param  string  $receiptNumberId  Identifies the credit note
