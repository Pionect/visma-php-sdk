 ...
 */
class ProjectTaskPostByinternalIdRequest extends Request implements HasBody
{
    use HasJsonBody;
     ...
     * @param  null|\Pionect\VismaSdk\Dto\ProjectTaskUpdateDto|array|null  $data  Request data
    ...
    public function __construct(
        ...
        protected ProjectTaskUpdateDto|array|null $data = null,
