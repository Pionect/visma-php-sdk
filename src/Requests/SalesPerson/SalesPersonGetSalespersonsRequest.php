...
/**
 * SalesPerson_GetSalespersons
 */
class SalesPersonGetSalespersonsRequest extends Request implements Paginatable
{
    protected $model = BasePaginationDtoOfSalesPersonDto::class;
    ...
    public function createDtoFromResponse(Response $response): mixed
    {
        ...
        return collect($data)->map(
            fn (array $item) => SalesPersonDto::from($item)
        );
    }
    ...
    public function __construct(
        protected ?string $salespersonCd = null,
        protected ?string $name = null,
        protected ?bool $isActive = null,
        protected float|int|null $commissionPct = null,
        protected ?string $salesSub = null,
    ...
    {
        return array_filter([
            'salespersonCD' => $this->salespersonCd,
            'name' => $this->name,
            'isActive' => $this->isActive,
            'commissionPct' => $this->commissionPct,
            'salesSub' => $this->salesSub,
