...
/**
 * LotSerialClass_GetByid
 */
class LotSerialClassGetByidRequest extends Request
{
    protected Method $method = Method::GET;

    public function createDtoFromResponse(Response $response): LotSerialClassDto
    {
    ...
    {
        return "/v1/lotserialclass/{$this->id}";
    }

    /**
     * @param  string  $id  Identifies the LotSerialClass
