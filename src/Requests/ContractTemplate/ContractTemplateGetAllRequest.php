...
namespace Pionect\VismaSdk\Requests\ContractTemplate;
...
/**
 * ContractTemplate_GetAll
 */
class ContractTemplateGetAllRequest extends Request implements Paginatable
{
    protected $model = ContractTemplateDto::class;
    ...
    public function createDtoFromResponse(Response $response): mixed
    {
        ...
        return collect($data)->map(
            fn (array $item) => ContractTemplateDto::from($item)
        );
    }

    public function resolveEndpoint(): string
    {
        return '/v1/contractTemplate';
    }
