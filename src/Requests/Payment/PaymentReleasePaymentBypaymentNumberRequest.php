...
/**
 * Payment_ReleasePaymentBypaymentNumber
 *
 * The action result dto contains information about the result of running the action
 */
class PaymentReleasePaymentBypaymentNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/payment/{$this->paymentNumberId}/action/release";
    }
