...
/**
 * Payment_VoidPaymentBypaymentNumber
 *
 * The action result dto contains information about the result of running the action
 */
class PaymentVoidPaymentBypaymentNumberRequest extends VismaMutationRequest
{
    protected Method $method = Method::POST;

    public function createDtoFromResponse(Response $response): VoidPaymentActionResultDto
    {
     ...
     * @param  null|\Pionect\VismaSdk\Dto\VoidPaymentActionDto|array|null  $data  Request data
    ...
    public function __construct(
        ...
        protected VoidPaymentActionDto|array|null $data = null,
