...
/**
 * Payment_GetBypaymentNumber
 */
class PaymentGetBypaymentNumberRequest extends Request
{
    ...
    {
        return "/v1/payment/{$this->paymentNumberId}";
    }

    /**
     * @param  string  $paymentNumberId  Identifies the Payment
