...
namespace Pionect\VismaSdk\Requests\Ledger;
...
/**
 * Ledger_GetAllLedgers
 */
class LedgerGetAllLedgersRequest extends Request implements Paginatable
{
    protected $model = LedgerDto::class;
    ...
    public function createDtoFromResponse(Response $response): mixed
    {
        ...
        return collect($data)->map(
            fn (array $item) => LedgerDto::from($item)
        );
    }
    ...
    /**
     * @param  null|string  $greaterThanValue  Excludes ledgers with value lower than entry
