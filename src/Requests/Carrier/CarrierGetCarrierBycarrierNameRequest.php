...
class CarrierGetCarrierBycarrierNameRequest extends Request
{
    ...
    public function createDtoFromResponse(Response $response): CarrierDto
    {
        return CarrierDto::from($response->json());
    }

    public function resolveEndpoint(): string
    {
        return "/v1/carrier/{$this->carrierName}";
    }

    /**
     * @param  string  $carrierName  Identifies the Carrier
