...
/**
 * Employee_GetAllEmployees
 */
class EmployeeGetAllEmployeesRequest extends Request implements Paginatable
{
    ...
    public function createDtoFromResponse(Response $response): mixed
    {
        ...
        return collect($data)->map(
            fn (array $item) => EmployeeDto::from($item)
        );
    }
    ...
    /**
     * @param  null|bool  $linkedToUser  If the employee is linked to a user.
    ...
    public function __construct(
        protected ?bool $linkedToUser = null,
    ...
    {
        return array_filter([
            'linkedToUser' => $this->linkedToUser,
