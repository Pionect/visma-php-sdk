...
/**
 * Employee_GetEmployeeByemployeeCd
 *
 * Data for a single employee. <br></br>
 * The response headers include an ETag after a successful GET
 * operation.
 */
class EmployeeGetEmployeeByemployeeCdRequest extends Request
{
    protected $model = EmployeeDto::class;
    ...
    {
        return "/v1/employee/{$this->employeeCdId}";
    }
