...
namespace Pionect\VismaSdk\Requests\TimeCard;
...
/**
 * TimeCard_SendTimeCardToApprovalBytimeCardCd
 *
 ...
 * when calling with 'erp-api-background' HTTP header.
 */
class TimeCardSendTimeCardToApprovalBytimeCardCdRequest extends VismaMutationRequest
{
    protected Method $method = Method::POST;

    public function createDtoFromResponse(Response $response): SendTimeCardToApprovalActionResultDto
    {
        return SendTimeCardToApprovalActionResultDto::from($response->json());
    }

    public function resolveEndpoint(): string
    {
        return "/v1/timeCard/{$this->timeCardCd}/action/approval";
    }

    /**
     * @param  string  $timeCardCd  Reference number of the time card to be sent to approval
