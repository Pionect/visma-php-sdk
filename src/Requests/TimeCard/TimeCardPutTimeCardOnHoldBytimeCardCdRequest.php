...
use Pionect\VismaSdk\Dto\PutTimeCardOnHoldActionResultDto;
...
/**
 * TimeCard_PutTimeCardOnHoldBytimeCardCd
 *
 ...
 */
class TimeCardPutTimeCardOnHoldBytimeCardCdRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/timeCard/{$this->timeCardCdId}/action/hold";
    }

    /**
     * @param  string  $timeCardCdId  Reference number of the time card to be put on hold
