...
/**
 * TimeCard_GetAllEmployeeTimeCards
 */
class TimeCardGetAllEmployeeTimeCardsRequest extends Request implements Paginatable
{
    ...
    public function createDtoFromResponse(Response $response): Collection
    {
        ...
        return collect($data)->map(
            fn (array $item) => TimeCardDto::from($item)
        );
    }
     ...
     * @param  null|string  $week  Identifies the week number of the time card
     * @param  null|string  $type  Identifies the type of the time card (Normal, Corrected, NormalCorrected)
