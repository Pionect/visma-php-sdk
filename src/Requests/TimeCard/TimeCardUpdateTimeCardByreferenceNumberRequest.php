 ...
 */
class TimeCardUpdateTimeCardByreferenceNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/timeCard/{$this->referenceNumber}";
    }

    /**
     * @param  string  $referenceNumber  Identifies the time card to update
     * @param  null|\Pionect\VismaSdk\Dto\TimeCardUpdateDto|array|null  $data  Request data
    ...
    public function __construct(
        ...
        protected TimeCardUpdateDto|array|null $data = null,
