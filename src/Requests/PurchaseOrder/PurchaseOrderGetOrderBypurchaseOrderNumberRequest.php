...
class PurchaseOrderGetOrderBypurchaseOrderNumberRequest extends Request
{
    ...
    public function createDtoFromResponse(Response $response): PurchaseOrderDto
    {
        return PurchaseOrderDto::from($response->json());
    }
    ...
    /**
     * @param  string  $purchaseOrderNumber  Identifies the Purchase Order
