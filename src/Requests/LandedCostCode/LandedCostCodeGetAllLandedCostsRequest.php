...
/**
 * LandedCostCode_GetAllLandedCosts
 */
class LandedCostCodeGetAllLandedCostsRequest extends Request implements Paginatable
{
    ...
    public function createDtoFromResponse(Response $response): Collection
    {
        ...
        return collect($data)->map(
            fn (array $item) => LandedCostCodeDto::from($item)
        );
    }

    public function resolveEndpoint(): string
    {
        return '/v1/landedCostCode';
    }

    /**
     * @param  null|string  $code  Landed Cost Code
     * @param  null|string  $greaterThanValue  Enter the from-value for Landed Cost Code
