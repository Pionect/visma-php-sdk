...
/**
 * KitAssembly_ReleaseKitAssemblyBytyperefNo
 *
 * The action result dto contains information about the result of running the action
 */
class KitAssemblyReleaseKitAssemblyBytyperefNoRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/kitassembly/{$this->typeId}/{$this->refNoId}/action/release";
    }
