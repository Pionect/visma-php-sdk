...
/**
 * KitAssembly_PutBytyperefNo
 *
 * Response Message has StatusCode NoContent if PUT operation succeed
 */
class KitAssemblyPutBytyperefNoRequest extends Request implements HasBody
{
    use HasJsonBody;
     ...
     * @param  null|\Pionect\VismaSdk\Dto\KitAssemblyUpdateDto|array|null  $data  Request data
    ...
    public function __construct(
        ...
        protected KitAssemblyUpdateDto|array|null $data = null,
