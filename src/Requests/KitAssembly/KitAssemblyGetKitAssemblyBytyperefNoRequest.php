...
/**
 * KitAssembly_GetKitAssemblyBytyperefNo
 */
class KitAssemblyGetKitAssemblyBytyperefNoRequest extends Request
{
    protected Method $method = Method::GET;

    public function createDtoFromResponse(Response $response): KitAssemblyDto
    {
        return KitAssemblyDto::from($response->json());
    }
