...
/**
 * Location_GetLocationBybAccountIdlocationId
 */
class LocationGetLocationBybAccountIdlocationIdRequest extends Request
{
    ...
    {
        return "/v1/location/{$this->bAccountIdId}/{$this->locationIdId}";
    }
