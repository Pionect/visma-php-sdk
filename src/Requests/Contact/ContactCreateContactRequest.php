 ...
 */
class ContactCreateContactRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    /**
     * @param  null|\Pionect\VismaSdk\Dto\ContactUpdateDto|array|null  $data  Request data
    ...
    public function __construct(
        protected ContactUpdateDto|array|null $data = null,
