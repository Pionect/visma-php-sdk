...
/**
 * Shipment_AddLineByshipmentNumber
 *
 * Response Message has StatusCode NoContent if POST operation succeeded
 */
class ShipmentAddLineByshipmentNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/shipment/{$this->shipmentNumber}/action/addLine";
    }

    /**
     * @param  string  $shipmentNumber  Identifies the Shipment to update
     * @param  null|\Pionect\VismaSdk\Dto\ShipmentDetailLineAddDto|array|null  $data  Request data
    ...
    public function __construct(
        ...
        protected ShipmentDetailLineAddDto|array|null $data = null,
