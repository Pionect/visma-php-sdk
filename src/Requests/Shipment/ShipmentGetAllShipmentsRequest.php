...
/**
 * Shipment_GetAllShipments
 */
class ShipmentGetAllShipmentsRequest extends Request implements Paginatable
{
    ...
    public function createDtoFromResponse(Response $response): mixed
    {
        ...
        return collect($data)->map(
            fn (array $item) => ShipmentDto::from($item)
        );
    }
    ...
    /**
     * @param  null|string  $greaterThanValue  This field has been deprecated and will be removed in future versions. The GreaterThanValue parameter has no effect on the result.
     ...
     *
     * _Note:_ __LastModifiedDateTime__ and __LastModifiedDateTimeCondition__ are __mutually inclusive__.
     * @param  null|string  $shipmentType  Filter by Shipment Type
     * @param  null|string  $shipmentDate  Shipment Date
     *
     * Accepted format:
     * * ```yyyy-MM-dd```
     * * ```yyyy-MM-dd HH:mm:ss```
     ...
     * @param  null|string  $shipmentDateCondition  This value represents the condition to be applied when retrieving records.
     *
     * Accepted values (without the single quotes):
     * * '&gt;' for greater than
     * * '&lt;' for less than
    ...
    public function __construct(
        ...
        protected ?string $shipmentDateCondition = null,
    ...
    public function defaultQuery(): array
    {
        return array_filter([
            ...
            'shipmentDateCondition' => $this->shipmentDateCondition,
