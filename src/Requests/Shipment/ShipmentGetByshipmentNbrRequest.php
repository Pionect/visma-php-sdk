...
/**
 * Shipment_GetByshipmentNbr
 *
 * Data for a single Shipment. <br></br>
...
class ShipmentGetByshipmentNbrRequest extends Request
{
    ...
    public function createDtoFromResponse(Response $response): ShipmentDto
    {
        return ShipmentDto::from($response->json());
    }
