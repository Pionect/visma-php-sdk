...
/**
 * Shipment_PutByshipmentNbr
 *
 * Response Message has StatusCode NoContent if PUT operation succeeded. <br></br>
 * Response Message
 * has StatusCode BadRequest if PUT operation failed. <br></br>
 * The response headers include an ETag
 * after a successful PUT operation. <br></br>
 */
class ShipmentPutByshipmentNbrRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    /**
     * @param  string  $shipmentNbr  Identifies the Shipment to update
     * @param  null|\Pionect\VismaSdk\Dto\ShipmentUpdateDto|array|null  $data  Request data
    ...
    public function __construct(
        ...
        protected ShipmentUpdateDto|array|null $data = null,
