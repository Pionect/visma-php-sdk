...
/**
 * Dimension_GetSegmentValueBydimensionIdsegmentIdpublicId
 */
class DimensionGetSegmentValueBydimensionIdsegmentIdpublicIdRequest extends Request
{
    ...
    {
        return "/v1/dimension/{$this->dimensionIdId}/{$this->segmentIdId}/publicid/{$this->publicIdId}";
    }

    /**
     * @param  string  $dimensionIdId  Identifies the Dimension
     * @param  int  $segmentIdId  Identifies the Segment
     * @param  string  $publicIdId  Identifies the SegmentValue by its publicId
