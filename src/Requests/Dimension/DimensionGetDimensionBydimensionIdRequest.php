...
/**
 * Dimension_GetDimensionBydimensionId
 */
class DimensionGetDimensionBydimensionIdRequest extends Request
{
    protected $model = DtoDimension::class;
     ...
     *
     * _Note:_ __LastModifiedDateTime__ and __LastModifiedDateTimeCondition__ are __mutually inclusive__.
     * @param  null|bool  $expandSegmentsValues  Flag can be used to return data without the segment values.
    ...
    public function __construct(
        ...
        protected ?bool $expandSegmentsValues = null,
    ...
    public function defaultQuery(): array
    {
        return array_filter([
            ...
            'expandSegmentsValues' => $this->expandSegmentsValues,
        ]);
    }
