...
/**
 * CashTransaction_GetAll
 *
 * Data for the Cash Transaction
 */
class CashTransactionGetAllRequest extends Request implements Paginatable
{
    ...
    public function createDtoFromResponse(Response $response): Collection
    {
        ...
        return collect($data)->map(
            fn (array $item) => CashTransactionDto::from($item)
        );
    }
