...
/**
 * CashTransaction_PutByreferenceNbr
 *
 ...
 */
class CashTransactionPutByreferenceNbrRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/cashTransaction/{$this->referenceNbr}";
    }

    /**
     * @param  string  $referenceNbr  Identifies the Cash Transaction to update
