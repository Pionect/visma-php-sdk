...
/**
 * CashTransaction_ReleaseByreferenceNbr
 *
...
class CashTransactionReleaseByreferenceNbrRequest extends Request implements HasBody
{
    ...
    protected $model = ReleaseCashTransactionActionResultDto::class;
    ...
    {
        return "/v1/cashTransaction/{$this->referenceNbrId}/action/release";
    }

    /**
     * @param  string  $referenceNbrId  Reference number of the cash transaction to be released.
