 ...
 */
class CashTransactionReverseByreferenceNbrRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/cashTransaction/{$this->referenceNbrId}/action/reverse";
    }

    /**
     * @param  string  $referenceNbrId  Reference number of the cash transaction to be reversed.
