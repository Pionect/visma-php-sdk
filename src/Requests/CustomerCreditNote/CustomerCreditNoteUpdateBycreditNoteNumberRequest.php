...
/**
 * CustomerCreditNote_UpdateBycreditNoteNumber
 *
 ...
 */
class CustomerCreditNoteUpdateBycreditNoteNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/customerCreditNote/{$this->creditNoteNumber}";
    }

    /**
     * @param  string  $creditNoteNumber  Identifies the Credit Note to update
     * @param  null|\Pionect\VismaSdk\Dto\CustomerCreditNoteUpdateDto|array|null  $data  Request data
