...
/**
 * CustomerCreditNote_CreateHeaderAttachmentBycreditNoteNumber
 *
 ...
 */
class CustomerCreditNoteCreateHeaderAttachmentBycreditNoteNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/customerCreditNote/{$this->creditNoteNumberId}/attachment";
    }
