 ...
 */
class CustomerCreditNoteCreateLineAttachmentBycreditNoteNumberlineNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/customerCreditNote/{$this->creditNoteNumberId}/{$this->lineNumberId}/attachment";
    }
