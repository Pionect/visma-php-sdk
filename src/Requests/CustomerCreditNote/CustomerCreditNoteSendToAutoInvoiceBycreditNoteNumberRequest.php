...
/**
 * CustomerCreditNote_SendToAutoInvoiceBycreditNoteNumber
 *
 ...
 */
class CustomerCreditNoteSendToAutoInvoiceBycreditNoteNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
