...
/**
 * CustomerCreditNote_GetBycreditNoteNumber
 *
 * Data for Customer Credit Note <br></br>
 * The response headers include an ETag after a successful GET
 * operation.
 */
class CustomerCreditNoteGetBycreditNoteNumberRequest extends Request
{
    ...
    /**
     * @param  string  $creditNoteNumberId  Identifies the Customer Credit Note
