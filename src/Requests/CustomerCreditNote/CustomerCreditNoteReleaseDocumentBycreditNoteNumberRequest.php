 ...
 */
class CustomerCreditNoteReleaseDocumentBycreditNoteNumberRequest extends Request implements HasBody
{
    use HasJsonBody;

    protected $model = ReleaseCustomerCreditNoteActionResultDto::class;
