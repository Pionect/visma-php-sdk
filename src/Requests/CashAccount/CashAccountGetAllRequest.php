 ...
 * CashAccount_GetAll
 */
class CashAccountGetAllRequest extends Request implements Paginatable
{
    ...
    public function createDtoFromResponse(Response $response): mixed
    {
        ...
        return collect($data)->map(
            fn (array $item) => CashAccountDto::from($item)
        );
    }

    public function resolveEndpoint(): string
    {
        return '/v1/cashaccount';
    }

    /**
     * @param  null|string  $greaterThanValue  Filter Cass account identifier greater than.
