...
/**
 * Customer_GetAllCustomerBalance
 */
class CustomerGetAllCustomerBalanceRequest extends Request implements Paginatable
{
    ...
    public function createDtoFromResponse(Response $response): mixed
    {
        ...
        return collect($data)->map(
            fn (array $item) => CustomerBalanceDto::from($item)
        );
    }

    public function resolveEndpoint(): string
    {
        return '/v1/customer/balance';
    }
