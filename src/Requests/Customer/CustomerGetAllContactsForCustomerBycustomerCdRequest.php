...
/**
 * Customer_GetAllContactsForCustomerBycustomerCd
 */
class CustomerGetAllContactsForCustomerBycustomerCdRequest extends Request implements Paginatable
{
    ...
    {
        return "/v1/customer/{$this->customerCd}/contact";
    }
