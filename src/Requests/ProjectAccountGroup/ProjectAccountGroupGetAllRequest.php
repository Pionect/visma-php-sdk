...
/**
 * ProjectAccountGroup_GetAll
 */
class ProjectAccountGroupGetAllRequest extends Request implements Paginatable
{
    protected Method $method = Method::GET;

    /**
     * @return Collection<int, ProjectAccountGroupDto>
     */
    public function createDtoFromResponse(Response $response): Collection
    {
        ...
        return collect($data)->map(
            fn (array $item) => ProjectAccountGroupDto::from($item)
        );
    }

    public function resolveEndpoint(): string
    {
        return '/v1/projectaccountgroup';
    }
