 ...
 */
class ProjectPostRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    /**
     * @param  null|\Pionect\VismaSdk\Dto\ProjectUpdateDto|array|null  $data  Request data
    ...
    public function __construct(
        protected ProjectUpdateDto|array|null $data = null,
