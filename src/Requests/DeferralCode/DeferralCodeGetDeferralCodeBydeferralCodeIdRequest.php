...
class DeferralCodeGetDeferralCodeBydeferralCodeIdRequest extends Request
{
    ...
    public function createDtoFromResponse(Response $response): DeferralCodeDto
    {
        return DeferralCodeDto::from($response->json());
    }

    public function resolveEndpoint(): string
    {
        return "/v1/deferralCode/{$this->deferralCodeId}";
    }

    /**
     * @param  string  $deferralCodeId  Identifies the DeferralCode
    ...
    public function __construct(
        protected string $deferralCodeId,
