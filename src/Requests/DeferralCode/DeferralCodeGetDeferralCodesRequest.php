...
/**
 * DeferralCode_GetDeferralCodes
 */
class DeferralCodeGetDeferralCodesRequest extends Request implements Paginatable
{
    protected Method $method = Method::GET;

    /**
     * @return Collection<int, DeferralCodeDto>
     */
    public function createDtoFromResponse(Response $response): Collection
    {
        ...
        return collect($data)->map(
            fn (array $item) => DeferralCodeDto::from($item)
        );
    }

    public function resolveEndpoint(): string
    {
        return '/v1/deferralCode';
    }
