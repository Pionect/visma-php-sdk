 ...
 */
class CustomerPaymentMethodUpdateCustomerPaymentMethodBycustomerIdcustomerPaymentMethodIdRequest extends Request implements HasBody
{
    use HasJsonBody;
     ...
     * @param  null|\Pionect\VismaSdk\Dto\CustomerPaymentMethodUpdateDto|array|null  $data  Request data
    ...
    public function __construct(
        ...
        protected CustomerPaymentMethodUpdateDto|array|null $data = null,
