...
/**
 * SupplierInvoice_CorrectInvoiceByinvoiceNumber
 *
 * The response headers include an ETag after a successful POST operation.
 */
class SupplierInvoiceCorrectInvoiceByinvoiceNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/supplierInvoice/{$this->invoiceNumberId}/action/correct";
    }

    /**
     * @param  string  $invoiceNumberId  Reference number of the document to be corrected
