 ...
 */
class SupplierInvoiceVoidInvoiceBydocumentTypeinvoiceNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/supplierInvoice/{$this->documentTypeId}/{$this->invoiceNumberId}/action/voidinvoice";
    }

    /**
     * @param  string  $documentTypeId  Document type of the document to be Voided
     * @param  string  $invoiceNumberId  Reference number of the document to be Voided
