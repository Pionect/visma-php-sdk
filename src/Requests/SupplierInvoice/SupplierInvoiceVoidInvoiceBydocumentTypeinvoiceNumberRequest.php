...
class SupplierInvoiceVoidInvoiceBydocumentTypeinvoiceNumberRequest extends Request implements HasBody
{
    ...
    {
        return "/v1/supplierInvoice/{$this->documentType}/{$this->invoiceNumber}/action/voidinvoice";
    }

    /**
     * @param  string  $documentType  Document type of the document to be Voided
     * @param  string  $invoiceNumber  Reference number of the document to be Voided
