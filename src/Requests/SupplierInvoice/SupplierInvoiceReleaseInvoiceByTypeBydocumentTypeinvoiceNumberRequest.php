...
class SupplierInvoiceReleaseInvoiceByTypeBydocumentTypeinvoiceNumberRequest extends Request implements HasBody
{
    ...
    {
        return "/v1/supplierInvoice/{$this->documentType}/{$this->invoiceNumber}/action/release";
    }

    /**
     * @param  string  $documentType  Document type of the released document to be reversed
