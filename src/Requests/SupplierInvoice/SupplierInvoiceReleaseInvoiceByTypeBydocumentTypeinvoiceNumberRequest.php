...
/**
 * SupplierInvoice_ReleaseInvoiceByTypeBydocumentTypeinvoiceNumber
 *
 ...
 */
class SupplierInvoiceReleaseInvoiceByTypeBydocumentTypeinvoiceNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/supplierInvoice/{$this->documentTypeId}/{$this->invoiceNumberId}/action/release";
    }

    /**
     * @param  string  $documentTypeId  Document type of the released document to be reversed
