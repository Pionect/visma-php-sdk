...
/**
 * SupplierInvoice_GetAllInvoices
 */
class SupplierInvoiceGetAllInvoicesCollectionRequest extends Request implements Paginatable
{
     ...
     * @param  null|bool  $expandApproval  Set to true to include approval information.
     * @param  null|bool  $expandNote  Set to true to include description.
     ...
     * @param  null|string  $item  Filter by Item used into the document lines
    ...
    public function __construct(
        ...
        protected ?bool $expandApproval = null,
    ...
    public function defaultQuery(): array
    {
        return array_filter([
            ...
            'expandLandedCosts' => $this->expandLandedCosts,
            'documentType' => $this->documentType,
            'released' => $this->released,
            'project' => $this->project,
            'expandApproval' => $this->expandApproval,
            'expandNote' => $this->expandNote,
            'numberToRead' => $this->numberToRead,
            'skipRecords' => $this->skipRecords,
            'status' => $this->status,
            'expandLinePrebookAccounts' => $this->expandLinePrebookAccounts,
            'branch' => $this->branch,
