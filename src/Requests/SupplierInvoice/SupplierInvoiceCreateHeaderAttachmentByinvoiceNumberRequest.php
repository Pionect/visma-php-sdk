...
/**
 * SupplierInvoice_CreateHeaderAttachmentByinvoiceNumber
 *
 ...
 */
class SupplierInvoiceCreateHeaderAttachmentByinvoiceNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/supplierInvoice/{$this->invoiceNumberId}/attachment";
    }
