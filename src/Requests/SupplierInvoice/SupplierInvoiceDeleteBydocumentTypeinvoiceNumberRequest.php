...
/**
 * SupplierInvoice_DeleteBydocumentTypeinvoiceNumber
 *
 * Response Message has StatusCode NoContent if DELETE operation succeed
 */
class SupplierInvoiceDeleteBydocumentTypeinvoiceNumberRequest extends Request
{
    ...
    /**
     * @param  string  $documentTypeId  Identifies the docType of Supplier Invoice to delete
     * @param  string  $invoiceNumberId  Identifies the Supplier Invoice to delete
