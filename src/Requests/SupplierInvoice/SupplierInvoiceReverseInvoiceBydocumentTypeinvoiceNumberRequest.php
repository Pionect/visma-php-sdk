 ...
 */
class SupplierInvoiceReverseInvoiceBydocumentTypeinvoiceNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/supplierInvoice/{$this->documentTypeId}/{$this->invoiceNumberId}/action/reverse";
    }
