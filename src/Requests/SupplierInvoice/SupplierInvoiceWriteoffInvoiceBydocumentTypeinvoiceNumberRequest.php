...
/**
 * SupplierInvoice_WriteoffInvoiceBydocumentTypeinvoiceNumber
 *
 ...
 */
class SupplierInvoiceWriteoffInvoiceBydocumentTypeinvoiceNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/supplierInvoice/{$this->documentTypeId}/{$this->invoiceNumberId}/action/writeoff";
    }

    /**
     * @param  string  $documentTypeId  Document type of the document to be Written Off
     * @param  string  $invoiceNumberId  Reference number of the document to be Written Off
