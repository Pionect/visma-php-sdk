...
class SupplierInvoiceWriteoffInvoiceBydocumentTypeinvoiceNumberRequest extends Request implements HasBody
{
    ...
    {
        return "/v1/supplierInvoice/{$this->documentType}/{$this->invoiceNumber}/action/writeoff";
    }

    /**
     * @param  string  $documentType  Document type of the document to be Written Off
     * @param  string  $invoiceNumber  Reference number of the document to be Written Off
