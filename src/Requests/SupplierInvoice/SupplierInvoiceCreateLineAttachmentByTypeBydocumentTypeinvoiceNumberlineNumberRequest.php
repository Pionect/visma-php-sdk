...
/**
 * SupplierInvoice_CreateLineAttachmentByTypeBydocumentTypeinvoiceNumberlineNumber
 *
 ...
 */
class SupplierInvoiceCreateLineAttachmentByTypeBydocumentTypeinvoiceNumberlineNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
