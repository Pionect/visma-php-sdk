...
/**
 * SupplierInvoice_CreateHeaderAttachmentByTypeBydocumentTypeinvoiceNumber
 *
 ...
 * after a successful POST operation.
 */
class SupplierInvoiceCreateHeaderAttachmentByTypeBydocumentTypeinvoiceNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/supplierInvoice/documentType/{$this->documentTypeId}/{$this->invoiceNumberId}/attachment";
    }
