...
/**
 * SupplierInvoice_CreateLineAttachmentByinvoiceNumberlineNumber
 *
 ...
 */
class SupplierInvoiceCreateLineAttachmentByinvoiceNumberlineNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/supplierInvoice/{$this->invoiceNumberId}/{$this->lineNumberId}/attachment";
    }
