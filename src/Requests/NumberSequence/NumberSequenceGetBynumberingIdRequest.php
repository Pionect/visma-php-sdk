...
class NumberSequenceGetBynumberingIdRequest extends Request
{
    ...
    public function createDtoFromResponse(Response $response): NumberingDto
    {
        return NumberingDto::from($response->json());
    }

    public function resolveEndpoint(): string
    {
        return "/v1/numberSequence/{$this->numberingId}";
    }

    /**
     * @param  string  $numberingId  Identifies the Numbering
