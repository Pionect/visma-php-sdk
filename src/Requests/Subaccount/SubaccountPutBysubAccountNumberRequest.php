...
/**
 * Subaccount_PutBysubAccountNumber
 *
 ...
 * include an ETag after a successful PUT operation.
 */
class SubaccountPutBysubAccountNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    /**
     * @param  string  $subAccountNumber  Identifies the Subaccount to update
     * @param  null|\Pionect\VismaSdk\Dto\SubAccountUpdateDto|array|null  $data  Request data
    ...
    public function __construct(
        ...
        protected SubAccountUpdateDto|array|null $data = null,
