...
class AttributeGetAttributeByattributeIdRequest extends Request
{
    ...
    public function createDtoFromResponse(Response $response): AttributeDto
    {
        return AttributeDto::from($response->json());
    }
    ...
    /**
     * @param  string  $attributeId  Identifies the attribute
