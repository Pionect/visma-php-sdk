...
/**
 * KitSpecifications_GetAll
 */
class KitSpecificationsGetAllRequest extends Request implements Paginatable
{
    protected Method $method = Method::GET;

    /**
     * @return Collection<int, KitSpecificationDto>
     */
    public function createDtoFromResponse(Response $response): Collection
    {
        ...
        return collect($data)->map(
            fn (array $item) => KitSpecificationDto::from($item)
        );
    }

    public function resolveEndpoint(): string
    {
        return '/v1/KitSpecifications';
    }
    ...
    public function __construct(
        ...
        protected ?string $kitInventoryId = null,
    ...
    public function defaultQuery(): array
    {
        return array_filter([
            ...
            'kitInventoryID' => $this->kitInventoryId,
