 ...
 */
class ProjectTransactionPutByrefNbrRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/projecttransaction/{$this->refNbr}";
    }

    /**
     * @param  string  $refNbr  Identifies the Project transaction document to update
