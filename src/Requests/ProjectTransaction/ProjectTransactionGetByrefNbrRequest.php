...
/**
 * ProjectTransaction_GetByrefNbr
 *
 * Data for project transaction  <br></br>
...
class ProjectTransactionGetByrefNbrRequest extends Request
{
    ...
    public function createDtoFromResponse(Response $response): ProjectTransactionDocumentDto
    {
    ...
    /**
     * @param  string  $refNbr  Identifies the project transaction document
