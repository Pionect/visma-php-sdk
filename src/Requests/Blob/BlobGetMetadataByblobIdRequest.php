...
/**
 * Blob_GetMetadataByblobId
 */
class BlobGetMetadataByblobIdRequest extends Request
{
    protected Method $method = Method::GET;

    public function createDtoFromResponse(Response $response): BlobMetadata
    {
        return BlobMetadata::from($response->json());
    }

    public function resolveEndpoint(): string
    {
        return "/v1/blob/metadata/{$this->blobId}";
    }
