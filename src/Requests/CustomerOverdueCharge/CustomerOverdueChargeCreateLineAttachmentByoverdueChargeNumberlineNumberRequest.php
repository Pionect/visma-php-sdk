 ...
 */
class CustomerOverdueChargeCreateLineAttachmentByoverdueChargeNumberlineNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/customerOverdueCharge/{$this->overdueChargeNumberId}/{$this->lineNumberId}/attachment";
    }
