 ...
 */
class CustomerOverdueChargeUpdateByoverdueChargeNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/customerOverdueCharge/{$this->overdueChargeNumber}";
    }

    /**
     * @param  string  $overdueChargeNumber  Identifies the Overdue Charge to update
     * @param  null|\Pionect\VismaSdk\Dto\CustomerOverdueChargeUpdateDto|array|null  $data  Request data
    ...
    public function __construct(
        ...
        protected CustomerOverdueChargeUpdateDto|array|null $data = null,
