...
class CustomerOverdueChargeReleaseDocumentByoverdueChargeNumberRequest extends Request implements HasBody
{
    ...
    {
        return "/v1/customerOverdueCharge/{$this->overdueChargeNumber}/action/release";
    }

    /**
     * @param  string  $overdueChargeNumber  Reference number of the overdue charge to be released
