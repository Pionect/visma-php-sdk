...
/**
 * CustomerOverdueCharge_ReleaseDocumentByoverdueChargeNumber
 *
 ...
 */
class CustomerOverdueChargeReleaseDocumentByoverdueChargeNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/customerOverdueCharge/{$this->overdueChargeNumberId}/action/release";
    }

    /**
     * @param  string  $overdueChargeNumberId  Reference number of the overdue charge to be released
