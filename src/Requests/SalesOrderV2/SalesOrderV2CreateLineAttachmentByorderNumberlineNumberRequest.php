 ...
 */
class SalesOrderV2CreateLineAttachmentByorderNumberlineNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v2/salesorder/{$this->orderNumberId}/{$this->lineNumberId}/attachment";
    }
