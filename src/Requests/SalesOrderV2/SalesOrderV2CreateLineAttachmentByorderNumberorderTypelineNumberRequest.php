...
/**
 * SalesOrderV2_CreateLineAttachmentByorderNumberorderTypelineNumber
 *
 * Response Message has StatusCode Created if POST operation succeed
 */
class SalesOrderV2CreateLineAttachmentByorderNumberorderTypelineNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v2/salesorder/orderType/{$this->orderTypeId}/{$this->orderNumberId}/{$this->lineNumberId}/attachment";
    }
