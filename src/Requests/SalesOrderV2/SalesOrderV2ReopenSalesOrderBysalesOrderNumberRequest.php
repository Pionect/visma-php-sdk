...
/**
 * SalesOrderV2_ReopenSalesOrderBysalesOrderNumber
 *
 * The action result dto contains information about the result of running the action
 */
class SalesOrderV2ReopenSalesOrderBysalesOrderNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v2/salesorder/{$this->salesOrderNumber}/action/reopenSalesOrder";
    }

    /**
     * @param  string  $salesOrderNumber  Identifies the Sale Order to reopen
     * @param  null|\Pionect\VismaSdk\Dto\ReopenSalesOrderActionDto|array|null  $data  Request data
    ...
    public function __construct(
        ...
        protected ReopenSalesOrderActionDto|array|null $data = null,
