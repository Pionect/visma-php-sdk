...
/**
 * SalesOrderV2_CreateHeaderAttachmentByorderNumberorderType
 *
 * Response Message has StatusCode Created if POST operation succeed
 */
class SalesOrderV2CreateHeaderAttachmentByorderNumberorderTypeRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v2/salesorder/orderType/{$this->orderTypeId}/{$this->orderNumberId}/attachment";
    }
