...
/**
 * PackagingType_GetAllPackagingTypes
 */
class PackagingTypeGetAllPackagingTypesCollectionRequest extends Request implements Paginatable
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return '/v1/packagingType';
    }

    /**
     * @param  null|string  $greaterThanValue  This field has been deprecated and will be removed in future versions.
