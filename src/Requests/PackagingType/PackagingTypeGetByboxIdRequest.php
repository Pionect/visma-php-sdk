...
/**
 * PackagingType_GetByboxId
 */
class PackagingTypeGetByboxIdRequest extends Request
{
    ...
    {
        return "/v1/packagingType/{$this->boxIdId}";
    }

    /**
     * @param  string  $boxIdId  Identifies the PackagingType
