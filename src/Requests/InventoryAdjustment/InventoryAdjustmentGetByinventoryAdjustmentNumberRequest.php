...
class InventoryAdjustmentGetByinventoryAdjustmentNumberRequest extends Request
{
    ...
    public function createDtoFromResponse(Response $response): InventoryAdjustmentDto
    {
        return InventoryAdjustmentDto::from($response->json());
    }

    public function resolveEndpoint(): string
    {
        return "/v1/inventoryadjustment/{$this->inventoryAdjustmentNumber}";
    }

    /**
     * @param  string  $inventoryAdjustmentNumber  Identifies the Inventory Adjustment document
