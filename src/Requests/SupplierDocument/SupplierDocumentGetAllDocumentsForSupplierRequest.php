...
namespace Pionect\VismaSdk\Requests\SupplierDocument;
...
/**
 * SupplierDocument_GetAllDocumentsForSupplier
 */
class SupplierDocumentGetAllDocumentsForSupplierRequest extends Request implements Paginatable
{
    protected Method $method = Method::GET;

    /**
     * @return Collection<int, SupplierDocumentDto>
     */
    public function createDtoFromResponse(Response $response): Collection
    {
        ...
        return collect($data)->map(
            fn (array $item) => SupplierDocumentDto::from($item)
        );
    }

    public function resolveEndpoint(): string
    {
        return '/v1/supplierdocument';
    }
