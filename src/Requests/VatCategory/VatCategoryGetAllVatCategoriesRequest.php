...
/**
 * VatCategory_GetAllVatCategories
 */
class VatCategoryGetAllVatCategoriesRequest extends Request implements Paginatable
{
    ...
    public function createDtoFromResponse(Response $response): mixed
    {
        ...
        return collect($data)->map(
            fn (array $item) => VatCategoryDto::from($item)
        );
    }

    public function resolveEndpoint(): string
    {
        return '/v1/vatCategory';
    }

    /**
     * @param  null|string  $vendorCd  The vendor number associated with the VAT category line.
