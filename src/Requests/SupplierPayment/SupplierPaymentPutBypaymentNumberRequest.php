...
/**
 * SupplierPayment_PutBypaymentNumber
 *
 ...
 */
class SupplierPaymentPutBypaymentNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/supplierPayment/{$this->paymentNumber}";
    }

    /**
     * @param  string  $paymentNumber  Identifies the Payment to update
     * @param  null|\Pionect\VismaSdk\Dto\SupplierPaymentUpdateDto|array|null  $data  Request data
    ...
    public function __construct(
        ...
        protected SupplierPaymentUpdateDto|array|null $data = null,
