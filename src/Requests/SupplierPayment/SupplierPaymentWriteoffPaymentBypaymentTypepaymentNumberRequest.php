...
/**
 * SupplierPayment_WriteoffPaymentBypaymentTypepaymentNumber
 *
 ...
 */
class SupplierPaymentWriteoffPaymentBypaymentTypepaymentNumberRequest extends Request implements HasBody
{
    use HasJsonBody;

    protected $model = WriteoffPaymentActionResultDto::class;
