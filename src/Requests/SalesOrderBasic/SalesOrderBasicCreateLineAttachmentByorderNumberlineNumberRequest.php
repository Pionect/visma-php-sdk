...
/**
 * SalesOrderBasic_CreateLineAttachmentByorderNumberlineNumber
 *
 * Response Message has StatusCode Created if POST operation succeed
 */
class SalesOrderBasicCreateLineAttachmentByorderNumberlineNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/salesorderbasic/{$this->orderNumberId}/{$this->lineNumberId}/attachment";
    }
