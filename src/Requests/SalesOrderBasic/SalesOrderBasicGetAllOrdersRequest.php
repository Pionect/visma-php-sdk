...
/**
 * SalesOrderBasic_GetAllOrders
 *
 * Data for all Sales Order Basic
 */
class SalesOrderBasicGetAllOrdersRequest extends Request implements Paginatable
{
    ...
    public function createDtoFromResponse(Response $response): mixed
    {
        ...
        return collect($data)->map(
            fn (array $item) => SalesOrderBasicDto::from($item)
        );
    }
    ...
    /**
     * @param  null|string  $orderType  Filter by Order type.
     * @param  null|string  $status  Select to filter on status on order.
     * @param  null|string  $greaterThanValue  Filter on Order no. greater than value.
     ...
     * @param  null|bool  $showNotes  Set to true to include notes.
