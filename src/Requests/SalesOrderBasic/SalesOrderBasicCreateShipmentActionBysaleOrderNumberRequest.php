 ...
 */
class SalesOrderBasicCreateShipmentActionBysaleOrderNumberRequest extends VismaMutationRequest
{
    ...
    {
        return "/v1/salesorderbasic/{$this->saleOrderNumber}/action/createShipment";
    }
