...
/**
 * SalesOrderBasic_CreateHeaderAttachmentByorderNumber
 *
 * Response Message has StatusCode Created if POST operation succeed
 */
class SalesOrderBasicCreateHeaderAttachmentByorderNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/salesorderbasic/{$this->orderNumberId}/attachment";
    }
