...
/**
 * PurchaseReceiptBasic_ReleaseInvoiceByreceiptNumber
 *
 * The action result dto contains information about the result of running the action
 */
class PurchaseReceiptBasicReleaseInvoiceByreceiptNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/PurchaseReceiptBasic/{$this->receiptNumberId}/action/release";
    }
