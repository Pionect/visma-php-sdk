...
/**
 * PurchaseReceiptBasic_PutByreceiptNumber
 *
 * Response Message has StatusCode NoContent if PUT operation succeed. <br></br>
 * Response Message has
 * StatusCode BadRequest if PUT operation failed. <br></br>
 * The response headers include an ETag after
 * a successful PUT operation. <br></br>
 */
class PurchaseReceiptBasicPutByreceiptNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/PurchaseReceiptBasic/{$this->receiptNumber}";
    }

    /**
     * @param  string  $receiptNumber  Identifies the  Purchase Receipt  to update
     * @param  null|\Pionect\VismaSdk\Dto\PurchaseReceiptBasicUpdateDto|array|null  $data  Request data
    ...
    public function __construct(
        ...
        protected PurchaseReceiptBasicUpdateDto|array|null $data = null,
