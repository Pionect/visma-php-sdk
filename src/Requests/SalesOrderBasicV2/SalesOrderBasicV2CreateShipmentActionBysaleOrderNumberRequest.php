...
/**
 * SalesOrderBasicV2_CreateShipmentActionBysaleOrderNumber
 *
 * The action result dto contains information about the result of running the action
 */
class SalesOrderBasicV2CreateShipmentActionBysaleOrderNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v2/salesorderbasic/{$this->saleOrderNumberId}/action/createShipment";
    }
