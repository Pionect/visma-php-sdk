...
/**
 * SalesOrderBasicV2_CreateLineAttachmentByorderNumberorderTypelineNumber
 *
...
class SalesOrderBasicV2CreateLineAttachmentByorderNumberorderTypelineNumberRequest extends VismaMutationRequest
{
    ...
    {
        return "/v2/salesorderbasic/orderType/{$this->orderType}/{$this->orderNumber}/{$this->lineNumber}/attachment";
    }
