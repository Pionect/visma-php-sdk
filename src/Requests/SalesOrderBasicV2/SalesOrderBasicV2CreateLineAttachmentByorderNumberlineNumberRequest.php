...
/**
 * SalesOrderBasicV2_CreateLineAttachmentByorderNumberlineNumber
 *
 * Response Message has StatusCode Created if POST operation succeed
 */
class SalesOrderBasicV2CreateLineAttachmentByorderNumberlineNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v2/salesorderbasic/{$this->orderNumberId}/{$this->lineNumberId}/attachment";
    }
