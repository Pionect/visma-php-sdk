...
/**
 * SalesOrderBasicV2_SendEmailActionByorderTypeorderNumber
 *
 * The action result dto contains information about the result of running the action
 */
class SalesOrderBasicV2SendEmailActionByorderTypeorderNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v2/salesorderbasic/{$this->orderTypeId}/{$this->orderNumberId}/action/sendbymail";
    }
