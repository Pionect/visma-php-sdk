...
/**
 * SalesOrderBasicV2_CreateHeaderAttachmentByorderNumber
 *
 * Response Message has StatusCode Created if POST operation succeed
 */
class SalesOrderBasicV2CreateHeaderAttachmentByorderNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
