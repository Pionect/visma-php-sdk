 ...
 */
class CustomerPaymentReleasePaymentBypaymentNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/customerPayment/{$this->paymentNumberId}/action/release";
    }
