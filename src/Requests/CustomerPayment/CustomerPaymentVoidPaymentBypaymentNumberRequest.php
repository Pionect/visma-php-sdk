...
/**
 * CustomerPayment_VoidPaymentBypaymentNumber
 *
 ...
 */
class CustomerPaymentVoidPaymentBypaymentNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/customerPayment/{$this->paymentNumber}/action/void";
    }
