...
/**
 * CustomerPayment_PutBypaymentNumber
 *
 ...
 */
class CustomerPaymentPutBypaymentNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/customerPayment/{$this->paymentNumber}";
    }

    /**
     * @param  string  $paymentNumber  Identifies the Payment to update
     * @param  null|\Pionect\VismaSdk\Dto\PaymentUpdateDto|array|null  $data  Request data
    ...
    public function __construct(
        ...
        protected PaymentUpdateDto|array|null $data = null,
