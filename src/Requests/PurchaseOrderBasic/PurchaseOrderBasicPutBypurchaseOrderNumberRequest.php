...
/**
 * PurchaseOrderBasic_PutBypurchaseOrderNumber
 *
 ...
 */
class PurchaseOrderBasicPutBypurchaseOrderNumberRequest extends VismaMutationRequest
{
    protected Method $method = Method::PUT;

    public function resolveEndpoint(): string
    {
        return "/v1/purchaseorderbasic/{$this->purchaseOrderNumber}";
    }

    /**
     * @param  string  $purchaseOrderNumber  Identifies the Purchase Order to update
     * @param  null|\Pionect\VismaSdk\Dto\PurchaseOrderBasicUpdateDto|array|null  $data  Request data
    ...
    public function __construct(
        ...
        protected PurchaseOrderBasicUpdateDto|array|null $data = null,
