...
/**
 * Multilanguage_PutSpecificInventoryDescrTranslationByinventoryNumberlanguageISO
 *
 * Response Message has StatusCode NoContent if PUT operation succeed
 */
class MultilanguagePutSpecificInventoryDescrTranslationByinventoryNumberlanguageIsoRequest extends Request implements HasBody
{
    use HasJsonBody;
