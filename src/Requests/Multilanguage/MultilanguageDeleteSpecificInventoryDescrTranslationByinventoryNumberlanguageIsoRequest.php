...
/**
 * Multilanguage_DeleteSpecificInventoryDescrTranslationByinventoryNumberlanguageISO
 *
 * Response Message has StatusCode NoContent if DEL operation succeed
 */
class MultilanguageDeleteSpecificInventoryDescrTranslationByinventoryNumberlanguageIsoRequest extends Request
{
