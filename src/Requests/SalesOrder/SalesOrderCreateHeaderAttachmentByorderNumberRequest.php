...
/**
 * SalesOrder_CreateHeaderAttachmentByorderNumber
 *
 * Response Message has StatusCode Created if POST operation succeed
 */
class SalesOrderCreateHeaderAttachmentByorderNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/salesorder/{$this->orderNumberId}/attachment";
    }
