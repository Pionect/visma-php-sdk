...
/**
 * SalesOrder_CreateShipmentActionBysaleOrderNumber
 *
 * The action result dto contains information about the result of running the action
 */
class SalesOrderCreateShipmentActionBysaleOrderNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/salesorder/{$this->saleOrderNumberId}/action/createShipment";
    }
