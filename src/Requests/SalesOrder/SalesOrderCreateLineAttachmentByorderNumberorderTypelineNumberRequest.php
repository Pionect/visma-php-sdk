...
/**
 * SalesOrder_CreateLineAttachmentByorderNumberorderTypelineNumber
 *
 * Response Message has StatusCode Created if POST operation succeed
 */
class SalesOrderCreateLineAttachmentByorderNumberorderTypelineNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/salesorder/orderType/{$this->orderTypeId}/{$this->orderNumberId}/{$this->lineNumberId}/attachment";
    }
