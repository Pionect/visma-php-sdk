...
/**
 * SalesOrder_CreateLineAttachmentByorderNumberlineNumber
 *
 * Response Message has StatusCode Created if POST operation succeed
 */
class SalesOrderCreateLineAttachmentByorderNumberlineNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
