...
class PurchaseReceiptAddPurchaseOrdersByreceiptNumberRequest extends Request implements HasBody
{
    ...
    {
        return "/v1/PurchaseReceipt/{$this->receiptNumberId}/action/addpurchaseorder";
    }

    /**
     * @param  string  $receiptNumberId  Reference number of the receipt to which to add the orders
