...
/**
 * PurchaseReceipt_PutByreceiptNumber
 *
 ...
 */
class PurchaseReceiptPutByreceiptNumberRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/PurchaseReceipt/{$this->receiptNumber}";
    }

    /**
     * @param  string  $receiptNumber  Identifies the  Purchase Receipt  to update
     * @param  null|\Pionect\VismaSdk\Dto\PurchaseReceiptUpdateDto|array|null  $data  Request data
    ...
    public function __construct(
        ...
        protected PurchaseReceiptUpdateDto|array|null $data = null,
