...
/**
 * CustomerSalesPrice_GetCustomerSalesPrices
 */
class CustomerSalesPriceGetCustomerSalesPricesRequest extends Request implements Paginatable
{
    ...
    public function createDtoFromResponse(Response $response): mixed
    {
        ...
        return collect($data)->map(
            fn (array $item) => CustomerSalesPriceDto::from($item)
        );
    }
    ...
    public function __construct(
        ...
        protected ?string $effectiveAsOf = null,
    ...
    public function defaultQuery(): array
    {
        return array_filter([
            ...
            'effectiveAsOf' => $this->effectiveAsOf,
