...
/**
 * CustomerSalesPrice_GetCustomerSalesPriceByrecordId
 *
...
class CustomerSalesPriceGetCustomerSalesPriceByrecordIdRequest extends Request
{
    ...
    public function createDtoFromResponse(Response $response): CustomerSalesPriceDto
    {
        return CustomerSalesPriceDto::from($response->json());
    }
    ...
    /**
     * @param  int  $recordId  The recordId of the Customer Sales Price
