...
/**
 * FixedAsset_GetByFixedAssetID
 */
class FixedAssetGetByFixedAssetIdRequest extends Request
{
    protected $model = FixedAssetDto::class;
    ...
    {
        return array_filter(['ExpandAccounts' => $this->expandAccounts]);
    }
