...
/**
 * Department_GetAllDepartmentDtos
 */
class DepartmentGetAllDepartmentDtosRequest extends Request implements Paginatable
{
    ...
    public function createDtoFromResponse(Response $response): mixed
    {
        ...
        return collect($data)->map(
            fn (array $item) => DepartmentDto::from($item)
        );
    }
