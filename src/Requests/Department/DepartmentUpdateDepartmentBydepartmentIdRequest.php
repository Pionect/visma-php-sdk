...
namespace Pionect\VismaSdk\Requests\Department;
 ...
 */
class DepartmentUpdateDepartmentBydepartmentIdRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    {
        return "/v1/department/{$this->departmentId}";
    }

    /**
     * @param  string  $departmentId  Identifies the department to update
     * @param  null|\Pionect\VismaSdk\Dto\DepartmentUpdateBaseDto|array|null  $data  Request data
    ...
    public function __construct(
        ...
        protected DepartmentUpdateBaseDto|array|null $data = null,
