...
/**
 * Supplier_GetAllSupplierPOBalance
 */
class SupplierGetAllSupplierPobalanceRequest extends Request implements Paginatable
{
    protected Method $method = Method::GET;

    /**
     * @return Collection<int, SupplierPobalanceDto>
     */
    public function createDtoFromResponse(Response $response): Collection
    {
        ...
        return collect($data)->map(
            fn (array $item) => SupplierPobalanceDto::from($item)
        );
    }

    public function resolveEndpoint(): string
    {
        return '/v1/supplier/POBalance';
    }
