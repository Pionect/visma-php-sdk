...
/**
 * Supplier_GetAllSupplierBalance
 */
class SupplierGetAllSupplierBalanceRequest extends Request implements Paginatable
{
    protected Method $method = Method::GET;

    /**
     * @return Collection<int, SupplierBalanceDto>
     */
    public function createDtoFromResponse(Response $response): Collection
    {
        ...
        return collect($data)->map(
            fn (array $item) => SupplierBalanceDto::from($item)
        );
    }

    public function resolveEndpoint(): string
    {
        return '/v1/supplier/balance';
    }
