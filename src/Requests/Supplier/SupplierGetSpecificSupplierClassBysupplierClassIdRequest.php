 ...
 *
 * Data for a single supplier class. <br></br>
...
class SupplierGetSpecificSupplierClassBysupplierClassIdRequest extends Request
{
    ...
    public function createDtoFromResponse(Response $response): SupplierClassDto
    {
        return SupplierClassDto::from($response->json());
    }

    public function resolveEndpoint(): string
    {
        return "/v1/supplier/supplierClass/{$this->supplierClassId}";
    }

    /**
     * @param  string  $supplierClassId  Identifies the supplier class
    ...
    public function __construct(
        protected string $supplierClassId,
