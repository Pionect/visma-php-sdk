 ...
 *
 * Data for a single supplier. <br></br>
...
class SupplierGetBysupplierCdRequest extends Request
{
    ...
    public function createDtoFromResponse(Response $response): SupplierDto
    {
        return SupplierDto::from($response->json());
    }
    ...
    /**
     * @param  string  $supplierCd  Identifies the supplier
