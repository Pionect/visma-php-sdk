 ...
 */
class SendTimeCardToApprovalActionResultDto extends SpatieData
{
    /** @use \Pionect\VismaSdk\Foundation\Factories\HasTestFactory<\Pionect\VismaSdk\Factories\SendTimeCardToApprovalActionResultDtoFactory> */
