 ...
 */
class CorrectArDocumentActionResultDto extends SpatieData
{
    /** @use \Pionect\VismaSdk\Foundation\Factories\HasTestFactory<\Pionect\VismaSdk\Factories\CorrectArDocumentActionResultDtoFactory> */
