...
/**
 * @method static \Pionect\VismaSdk\Factories\TaskUpdateDtoFactory testFactory()
 */
class TaskUpdateDto extends SpatieData
{
    /** @use \Pionect\VismaSdk\Foundation\Factories\HasTestFactory<\Pionect\VismaSdk\Factories\TaskUpdateDtoFactory> */
