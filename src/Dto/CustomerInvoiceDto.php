...
{
    /** @use \Pionect\VismaSdk\Foundation\Factories\HasTestFactory<\Pionect\VismaSdk\Factories\CustomerInvoiceDtoFactory> */
    ...
    public function __construct(
        ...
        /**
         * Mandatory field: The top part > Cash discount date * > The end date of the
         * cash discount period, which the system calculates by using the credit terms.
         */
        ...
        /**
         * The Financial details tab > The dunning info section > Dunning letter date >
         * The date of the last released dunning letter in which the document was
         * listed.
         */
        public ?\Carbon\Carbon $dunningLetterDate = null,
        /**
         * The Financial details tab > The dunning info section > Dunning level > The
