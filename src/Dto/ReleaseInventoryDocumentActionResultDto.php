 ...
 */
class ReleaseInventoryDocumentActionResultDto extends SpatieData
{
    /** @use \Pionect\VismaSdk\Foundation\Factories\HasTestFactory<\Pionect\VismaSdk\Factories\ReleaseInventoryDocumentActionResultDtoFactory> */
