 ...
 *
 * @method static \Pionect\VismaSdk\Factories\CustomerOverdueChargeDtoFactory factory()
 */
class CustomerOverdueChargeDto extends Model
{
    #[Property]
    public ?creditTermsInCustomerOverdueChargeDto $creditTerms;
    ...
    /** Madatory field: The top part &gt; Cash discount date* &gt; The end date of the cash discount period, which the system calculates by using the credit terms. */
    #[Property]
    #[DateTime]
    ...
    /** Financial details tab &gt; Dunning information section &gt; Dunning letter date &gt; The date of the last released dunning letter in which the document was listed. */
    #[Property]
    #[DateTime]
    public ?\Carbon\Carbon $dunningLetterDate;

    /** Financial details tab &gt; Dunning information section &gt; Dunning level &gt; The dunning level of the document. */
    #[Property]
    public ?int $dunningLetterLevel;

    #[Property]
    public ?contactInCustomerOverdueChargeDto $contact;
    ...
    #[Property]
    public ?customerVatZoneInCustomerOverdueChargeDto $customerVatZone;
    ...
    #[Property]
    public ?salesPersonInCustomerOverdueChargeDto $salesPerson;
    ...
    #[Property]
    public ?invoiceAddressInCustomerOverdueChargeDto $invoiceAddress;

    #[Property]
    public ?invoiceContactInCustomerOverdueChargeDto $invoiceContact;
    ...
    #[Property]
    public ?customerInCustomerOverdueChargeDto $customer;
    ...
    #[Property]
    public ?paymentMethodInCustomerOverdueChargeDto $paymentMethod;
    ...
    #[Property]
    public ?locationInCustomerOverdueChargeDto $location;

    #[Property]
    public ?branchNumberInCustomerOverdueChargeDto $branchNumber;
    ...
    #[Property]
    public ?projectInCustomerOverdueChargeDto $project;

    #[Property]
    public ?accountInCustomerOverdueChargeDto $account;

    #[Property]
    public ?subaccountInCustomerOverdueChargeDto $subaccount;
