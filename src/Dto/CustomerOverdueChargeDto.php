 ...
 */
class CustomerOverdueChargeDto extends SpatieData
{
    /** @use \Pionect\VismaSdk\Foundation\Factories\HasTestFactory<\Pionect\VismaSdk\Factories\CustomerOverdueChargeDtoFactory> */
    use \Pionect\VismaSdk\Foundation\Factories\HasTestFactory;

    public function __construct(
        public ?CreditTermsInCustomerOverdueChargeDto $creditTerms = null,
        /**
         * Mandatory field: The Top part > Due date* > The date when payment for the
         * document is due, in accordance with the credit terms.
         */
        public ?\Carbon\Carbon $documentDueDate = null,
        /**
         * Madatory field: The top part > Cash discount date* > The end date of the cash
         * discount period, which the system calculates by using the credit terms.
         */
        ...
        /**
         * Financial details tab > Dunning information section > Dunning letter date >
         * The date of the last released dunning letter in which the document was
         * listed.
         */
        public ?\Carbon\Carbon $dunningLetterDate = null,
        /**
         * Financial details tab > Dunning information section > Dunning level > The
         * dunning level of the document.
         */
