...
{
    /** @use \Pionect\VismaSdk\Foundation\Factories\HasTestFactory<\Pionect\VismaSdk\Factories\CustomerDebitNoteLineDtoFactory> */
    ...
    public function __construct(
        ...
        /**
         * Domestic services deductible document > A check box indicating if the
         * document is Rot/rut deductible (applicable for the Swedish markets)
         */
