...
/**
 * @method static \Pionect\VismaSdk\Factories\CustomerInvoiceLineDtoFactory testFactory()
 */
class CustomerInvoiceLineDto extends SpatieData
{
    /** @use \Pionect\VismaSdk\Foundation\Factories\HasTestFactory<\Pionect\VismaSdk\Factories\CustomerInvoiceLineDtoFactory> */
    use \Pionect\VismaSdk\Foundation\Factories\HasTestFactory;

    public function __construct(
        /**
         * Term start date > The date when the process of deferred revenue recognition
         * should start for the selected item; this date can be specified manually if
         * the deferral code assigned to the item is based on the Flexible by periods,
         * prorate by days or Flexible by days in period recognition method.
         * This column only appears if the Deferred revenue management functionality is
         * enabled in the(CS100000) window.
         */
        public ?\Carbon\Carbon $termStartDate = null,
        /**
         * Term end date > The date when the process of the deferred revenue
         * recognition should finish for the selected item; this date can be specified
         * manually if the deferral code assigned to the item is based on the Flexible
         * by periods, prorate by days or Flexible by days in period recognition
         * method.
         * This column only appears if the Deferred revenue management functionality is
         * enabled in the(CS100000) window.
         */
