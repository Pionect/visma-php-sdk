 ...
 *
 * @method static \Pionect\VismaSdk\Factories\InventoryAdjustmentDtoFactory testFactory()
 */
class InventoryAdjustmentDto extends SpatieData
{
    /** @use \Pionect\VismaSdk\Foundation\Factories\HasTestFactory<\Pionect\VismaSdk\Factories\InventoryAdjustmentDtoFactory> */
    ...
    public function __construct(
        ...
        /**
         * The top part > Control cost > The manually entered cost of stock items listed
         * in the adjustment. Control cost is available only if the Validate document
         * totals on Entry option is selected on the Inventory preferences window.
         * The user enters this value manually to confirm the total cost as calculated
         * automatically for the document. If the Control Cost and Total Cost values
         * do not match, the system generates a warning message and the document cannot
         * be saved.
         */
