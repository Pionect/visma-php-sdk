...
/**
 * @method static \Pionect\VismaSdk\Factories\CustomerCreditWriteOffDtoFactory testFactory()
 */
class CustomerCreditWriteOffDto extends SpatieData
{
    /** @use \Pionect\VismaSdk\Foundation\Factories\HasTestFactory<\Pionect\VismaSdk\Factories\CustomerCreditWriteOffDtoFactory> */
    use \Pionect\VismaSdk\Foundation\Factories\HasTestFactory;

    public function __construct(
        /**
         * The top part > Hold > A check box that indicates if the document is a draft.
