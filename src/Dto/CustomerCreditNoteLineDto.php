...
/**
 * @method static \Pionect\VismaSdk\Factories\CustomerCreditNoteLineDtoFactory testFactory()
 */
class CustomerCreditNoteLineDto extends SpatieData
{
    /** @use \Pionect\VismaSdk\Foundation\Factories\HasTestFactory<\Pionect\VismaSdk\Factories\CustomerCreditNoteLineDtoFactory> */
    use \Pionect\VismaSdk\Foundation\Factories\HasTestFactory;

    public function __construct(
        /**
         * The date when the process of deferred revenue recognition should start for
         * the
         * selected item; this date can be specified manually if the deferral code
         * assigned
         * to the item is based on the Flexible by Periods, Prorate by days or Flexible
         * by
         ...
         * for the selected item; this date can be specified manually if the deferral
         * code
         * assigned to the item is based on the Flexible by Periods, Prorate by days or
         * Flexible by Days in Period recognition method.This column appears only if
         * the
         * Deferred Revenue Management feature is enabled on the Enable/Disable Features
         * form.
         */
