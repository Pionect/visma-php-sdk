...
{
    /** @use \Pionect\VismaSdk\Foundation\Factories\HasTestFactory<\Pionect\VismaSdk\Factories\InventoryIssueDtoFactory> */
    use \Pionect\VismaSdk\Foundation\Factories\HasTestFactory;

    public function __construct(
        /**
         * The top part > Total amount > The total amount, calculated as a sum of
         * amounts for all inventory issue operations included in this issue document.
         */
        public int|float|null $totalAmount = null,
        /**
         * The top part > Control amount > The manually entered summary amount for all
         * specified inventory items. Control Amount is available only if
         * the Validate Document Totals on Entry option is selected on the Inventory
         * Preferences form. If the Control Amount and Total Amount values do not
         * match, the system generates a warning message and the issue cannot be saved.
         */
