...
it('calls the customerPutByinternalIdRequest method in the Customer resource', function () {
    $bodyData = new CustomerUpdateDto(
        ...
        invoiceContact: new \Pionect\VismaSdk\Dto\ContactInfoUpdateDto(
            name: 'String value',
            attention: 'String value',
            email: 'test@example.com',
            web: 'String value',
        ...
        deliveryContact: new \Pionect\VismaSdk\Dto\ContactInfoUpdateDto(
            name: 'String value',
            attention: 'String value',
            email: 'test@example.com',
            web: 'String value',
        ...
        eInvoiceContract: new \Pionect\VismaSdk\Dto\EinvoiceContractUpdateDto(
            fInvoiceContractId: 'mock-id-123',
            fInvoiceIntermediatorId: 'mock-id-123'
        ),
        defaultPaymentMethod: new \Pionect\VismaSdk\Dto\CustomerDefaultPaymentMethodUpdateDto(
            paymentMethodId: 'mock-id-123',
            isDefault: true
        ),
        glAccounts: new \Pionect\VismaSdk\Dto\CustomerGlAccountsUpdateDto(
            customerLedgerAccount: 'String value',
            customerLedgerSubaccount: [],
            ...
            salesSubaccount: [],
            discountAccount: 'String value',
            discountSubaccount: [],
            freightAccount: 'String value',
            freightSubaccount: [],
            cashDiscountAccount: 'String value',
            cashDiscountSubaccount: [],
            prepaymentAccount: 'String value',
            prepaymentSubaccount: []
        ),
        directDebitLines: [],
        attributeLines: [],
