...
use Carbon\Carbon;
use Pionect\VismaSdk\Requests\CustomerCreditNote\CustomerCreditNoteGetAllCollectionRequest;
...
it('calls the customerCreditNoteGetBycreditNoteNumber method in the CustomerCreditNote resource', function () {
    Saloon::fake([
        CustomerCreditNoteGetBycreditNoteNumberRequest::class => MockResponse::make([
            'data' => [
                'type' => 'customerCreditNotes',
                'id' => 'mock-id-123',
                'attributes' => [
...
it('calls the customerCreditNoteGetAllCollection method in the CustomerCreditNote resource', function () {
    Saloon::fake([
        CustomerCreditNoteGetAllCollectionRequest::class => MockResponse::make([
            'data' => [
                0 => [
                    'type' => 'customerCreditNotes',
                    'id' => 'mock-id-1',
...
it('calls the customerCreditNoteReleaseDocumentBycreditNoteNumber method in the CustomerCreditNote resource', function () {
    $mockClient = Saloon::fake([
        CustomerCreditNoteReleaseDocumentBycreditNoteNumberRequest::class => MockResponse::make([], 200),
    ]);

    // Create DTO with sample data
    $dto = \Pionect\VismaSdk\Dto\ReleaseCustomerCreditNoteActionResultDto::factory()->state([
