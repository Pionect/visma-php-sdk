...
use Carbon\Carbon;
use Pionect\VismaSdk\Dto\SupplierInvoiceForSupplierQueryParameters;
...
/**
 * @extends \Pionect\VismaSdk\Foundation\Factories\Factory<\Pionect\VismaSdk\Dto\SupplierInvoiceForSupplierQueryParameters>
 */
class SupplierInvoiceForSupplierQueryParametersFactory extends Factory
{
    ...
    {
        return SupplierInvoiceForSupplierQueryParameters::class;
    }
}
