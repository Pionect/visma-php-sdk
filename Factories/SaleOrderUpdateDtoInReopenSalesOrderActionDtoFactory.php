...
/**
 * @extends \Pionect\VismaSdk\Foundation\Factories\Factory<\Pionect\VismaSdk\Dto\SaleOrderUpdateDtoInReopenSalesOrderActionDto>
 */
class SaleOrderUpdateDtoInReopenSalesOrderActionDtoFactory extends Factory
{
    protected function definition(): array
    {
        return [
            ...
            'soBillingContact' => SalesOrderContactUpdateDtoFactory::new()->make(),
            'soBillingAddress' => SalesOrderAddressUpdateDtoFactory::new()->make(),
            ...
            'soShippingContact' => SalesOrderContactUpdateDtoFactory::new()->make(),
            'soShippingAddress' => SalesOrderAddressUpdateDtoFactory::new()->make(),
