...
class SupplierPaymentDtoFactory extends Factory
{
    protected function definition(): array
    {
        return [
            ...
            'supplier' => SupplierInSupplierPaymentDtoFactory::new()->make(),
            'location' => LocationInSupplierPaymentDtoFactory::new()->make(),
            'paymentMethod' => $this->faker->word(),
            'cashAccount' => $this->faker->word(),
            'currency' => CurrencyInSupplierPaymentDtoFactory::new()->make(),
