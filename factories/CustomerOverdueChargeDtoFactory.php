...
class CustomerOverdueChargeDtoFactory extends Factory
{
    ...
    {
        return [
            'creditTerms' => CreditTermsInCustomerOverdueChargeDtoFactory::new()->make(),
            ...
            'contact' => ContactInCustomerOverdueChargeDtoFactory::new()->make(),
            'attachments' => [],
            'taxDetails' => [],
            'lines' => [],
            'roundingDiff' => $this->faker->randomFloat(2, 0, 1000),
            'customerVatZone' => CustomerVatZoneInCustomerOverdueChargeDtoFactory::new()->make(),
            ...
            'salesPerson' => SalesPersonInCustomerOverdueChargeDtoFactory::new()->make(),
            'paymentReference' => $this->faker->word(),
            'invoiceAddress' => InvoiceAddressInCustomerOverdueChargeDtoFactory::new()->make(),
            'invoiceContact' => InvoiceContactInCustomerOverdueChargeDtoFactory::new()->make(),
            'applications' => [],
            'dontPrint' => $this->faker->boolean(),
            'dontEmail' => $this->faker->boolean(),
            'revoked' => $this->faker->boolean(),
            'customer' => CustomerInCustomerOverdueChargeDtoFactory::new()->make(),
            ...
            'paymentMethod' => PaymentMethodInCustomerOverdueChargeDtoFactory::new()->make(),
            ...
            'location' => LocationInCustomerOverdueChargeDtoFactory::new()->make(),
            'branchNumber' => BranchNumberInCustomerOverdueChargeDtoFactory::new()->make(),
            'cashAccount' => $this->faker->word(),
            'project' => ProjectInCustomerOverdueChargeDtoFactory::new()->make(),
            'account' => AccountInCustomerOverdueChargeDtoFactory::new()->make(),
            'subaccount' => SubaccountInCustomerOverdueChargeDtoFactory::new()->make(),
    ...
    {
        return CustomerOverdueChargeDto::class;
    }
}
