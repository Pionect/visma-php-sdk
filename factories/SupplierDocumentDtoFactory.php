...
class SupplierDocumentDtoFactory extends Factory
{
    ...
    {
        return [
            'account' => AccountInSupplierDocumentDtoFactory::new()->make(),
            'subaccount' => SubaccountInSupplierDocumentDtoFactory::new()->make(),
            'amount' => $this->faker->randomFloat(2, 0, 1000),
            'amountInCurrency' => $this->faker->randomFloat(2, 0, 1000),
            'branch' => BranchInSupplierDocumentDtoFactory::new()->make(),
            'supplier' => SupplierInSupplierDocumentDtoFactory::new()->make(),
            ...
            'paymentMethod' => PaymentMethodInSupplierDocumentDtoFactory::new()->make(),
            ...
            'location' => LocationInSupplierDocumentDtoFactory::new()->make(),
