...
class PurchaseOrderDtoFactory extends Factory
{
    protected function definition(): array
    {
        return [
            ...
            'shipTo' => ShipToInPurchaseOrderDtoFactory::new()->make(),
            'shippingLocation' => ShippingLocationInPurchaseOrderDtoFactory::new()->make(),
            'warehouse' => WarehouseInPurchaseOrderDtoFactory::new()->make(),
            'shippingContact' => ShippingContactInPurchaseOrderDtoFactory::new()->make(),
            'shippingAddress' => ShippingAddressInPurchaseOrderDtoFactory::new()->make(),
            'fobPoint' => $this->faker->word(),
            'shipVia' => $this->faker->word(),
            'shipTerms' => $this->faker->word(),
            'remitContact' => RemitContactInPurchaseOrderDtoFactory::new()->make(),
            'remitAddress' => RemitAddressInPurchaseOrderDtoFactory::new()->make(),
            'terms' => TermsInPurchaseOrderDtoFactory::new()->make(),
            'supplierVatZone' => SupplierVatZoneInPurchaseOrderDtoFactory::new()->make(),
            'discountDetails' => [],
            ...
            'supplier' => SupplierInPurchaseOrderDtoFactory::new()->make(),
            'location' => LocationInPurchaseOrderDtoFactory::new()->make(),
            'owner' => OwnerInPurchaseOrderDtoFactory::new()->make(),
            ...
            'branch' => BranchInPurchaseOrderDtoFactory::new()->make(),
            'lines' => [],
            'taxDetails' => [],
            'purchaseReceipts' => [],
