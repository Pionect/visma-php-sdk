...
class CustomerInvoiceDtoFactory extends Factory
{
    ...
    {
        return [
            'creditTerms' => CreditTermsInCustomerInvoiceDtoFactory::new()->make(),
            ...
            'contact' => ContactInCustomerInvoiceDtoFactory::new()->make(),
            'attachments' => [],
            'taxDetails' => [],
            'invoiceLines' => [],
            'sendToAutoInvoice' => $this->faker->boolean(),
            'roundingDiff' => $this->faker->randomFloat(2, 0, 1000),
            'customerVatZone' => CustomerVatZoneInCustomerInvoiceDtoFactory::new()->make(),
            ...
            'debtCollection' => DebtCollectionInCustomerInvoiceDtoFactory::new()->make(),
            ...
            'salesPerson' => SalesPersonInCustomerInvoiceDtoFactory::new()->make(),
            'paymentReference' => $this->faker->word(),
            'invoiceAddress' => InvoiceAddressInCustomerInvoiceDtoFactory::new()->make(),
            'invoiceContact' => InvoiceContactInCustomerInvoiceDtoFactory::new()->make(),
            'applications' => [],
            'dontPrint' => $this->faker->boolean(),
            'dontEmail' => $this->faker->boolean(),
            'revoked' => $this->faker->boolean(),
            'customer' => CustomerInCustomerInvoiceDtoFactory::new()->make(),
            ...
            'paymentMethod' => PaymentMethodInCustomerInvoiceDtoFactory::new()->make(),
            ...
            'location' => LocationInCustomerInvoiceDtoFactory::new()->make(),
            'branchNumber' => BranchNumberInCustomerInvoiceDtoFactory::new()->make(),
            'cashAccount' => $this->faker->word(),
            'project' => ProjectInCustomerInvoiceDtoFactory::new()->make(),
            'account' => AccountInCustomerInvoiceDtoFactory::new()->make(),
            'subaccount' => SubaccountInCustomerInvoiceDtoFactory::new()->make(),
