...
class ExpenseClaimDtoFactory extends Factory
{
    protected function definition(): array
    {
        return [
            ...
            'claimedBy' => ClaimedByInExpenseClaimDtoFactory::new()->make(),
            ...
            'customer' => CustomerInExpenseClaimDtoFactory::new()->make(),
            'currency' => $this->faker->word(),
            'approvalDate' => Carbon::now()->subDays($this->faker->numberBetween(0, 365)),
            'department' => DepartmentInExpenseClaimDtoFactory::new()->make(),
            'location' => LocationInExpenseClaimDtoFactory::new()->make(),
