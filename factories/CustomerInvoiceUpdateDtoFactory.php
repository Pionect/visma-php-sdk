...
class CustomerInvoiceUpdateDtoFactory extends Factory
{
    protected function definition(): array
    {
        return [
            ...
            'overrideNumberSeries' => OverrideNumberSeriesInCustomerInvoiceUpdateDtoFactory::new()->make(),
            ...
            'postPeriod' => PostPeriodInCustomerInvoiceUpdateDtoFactory::new()->make(),
            'financialPeriod' => FinancialPeriodInCustomerInvoiceUpdateDtoFactory::new()->make(),
            'invoiceText' => $this->faker->word(),
            'locationId' => $this->faker->uuid(),
            'salesPersonId' => SalesPersonIDInCustomerInvoiceUpdateDtoFactory::new()->make(),
            'salesperson' => SalespersonInCustomerInvoiceUpdateDtoFactory::new()->make(),
