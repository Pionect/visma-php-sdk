...
class PurchaseOrderBasicDtoFactory extends Factory
{
    protected function definition(): array
    {
        return [
            ...
            'supplier' => SupplierInPurchaseOrderBasicDtoFactory::new()->make(),
            'location' => LocationInPurchaseOrderBasicDtoFactory::new()->make(),
            'owner' => OwnerInPurchaseOrderBasicDtoFactory::new()->make(),
            ...
            'branch' => BranchInPurchaseOrderBasicDtoFactory::new()->make(),
            'lines' => [],
            'taxDetails' => [],
            'purchaseReceipts' => [],
