...
class GeneralLedgerTransactionDetailsDtoFactory extends Factory
{
    protected function definition(): array
    {
        return [
            ...
            'branch' => BranchInGeneralLedgerTransactionDetailsDtoFactory::new()->make(),
            'account' => AccountInGeneralLedgerTransactionDetailsDtoFactory::new()->make(),
            'ledger' => LedgerInGeneralLedgerTransactionDetailsDtoFactory::new()->make(),
