...
class CustomerDebitNoteLineDtoFactory extends Factory
{
    protected function definition(): array
    {
        return [
            ...
            'account' => AccountInCustomerDebitNoteLineDtoFactory::new()->make(),
            'vatCode' => VatCodeInCustomerDebitNoteLineDtoFactory::new()->make(),
            'uom' => $this->faker->word(),
            ...
            'subaccount' => SubaccountInCustomerDebitNoteLineDtoFactory::new()->make(),
            'salesperson' => $this->faker->word(),
            'seller' => SellerInCustomerDebitNoteLineDtoFactory::new()->make(),
            'deferralSchedule' => $this->faker->numberBetween(1, 100),
            'deferralCode' => $this->faker->word(),
            'discountCode' => $this->faker->word(),
            'note' => $this->faker->word(),
            'branchNumber' => BranchNumberInCustomerDebitNoteLineDtoFactory::new()->make(),
