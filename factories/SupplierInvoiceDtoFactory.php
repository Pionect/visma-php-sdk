...
class SupplierInvoiceDtoFactory extends Factory
{
    protected function definition(): array
    {
        return [
            'taxDetailLines' => [],
            'attachments' => [],
            'approvalDetails' => ApprovalDetailsInSupplierInvoiceDtoFactory::new()->make(),
            'invoiceLines' => [],
            'landedCosts' => [],
            'hold' => $this->faker->boolean(),
            'exchangeRate' => $this->faker->randomFloat(2, 0, 1000),
            'paymentRefNo' => $this->faker->word(),
            'creditTerms' => CreditTermsInSupplierInvoiceDtoFactory::new()->make(),
            ...
            'supplierTaxZone' => SupplierTaxZoneInSupplierInvoiceDtoFactory::new()->make(),
            ...
            'supplier' => SupplierInSupplierInvoiceDtoFactory::new()->make(),
            ...
            'paymentMethod' => PaymentMethodInSupplierInvoiceDtoFactory::new()->make(),
            ...
            'location' => LocationInSupplierInvoiceDtoFactory::new()->make(),
