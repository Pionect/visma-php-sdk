...
class SalesOrderBasicUpdateDtoFactory extends Factory
{
    protected function definition(): array
    {
        return [
            'lines' => [],
            'orderType' => OrderTypeInSalesOrderBasicUpdateDtoFactory::new()->make(),
            ...
            'customer' => CustomerInSalesOrderBasicUpdateDtoFactory::new()->make(),
            'location' => $this->faker->word(),
            'contactId' => $this->faker->numberBetween(1, 1000),
            'gln' => GlnInSalesOrderBasicUpdateDtoFactory::new()->make(),
            'vatRegistrationId' => VatRegistrationIdInSalesOrderBasicUpdateDtoFactory::new()->make(),
