...
class PurchaseReceiptDtoFactory extends Factory
{
    protected function definition(): array
    {
        return [
            ...
            'warehouse' => WarehouseInPurchaseReceiptDtoFactory::new()->make(),
            'supplier' => SupplierInPurchaseReceiptDtoFactory::new()->make(),
            'location' => LocationInPurchaseReceiptDtoFactory::new()->make(),
            ...
            'branchNumber' => BranchNumberInPurchaseReceiptDtoFactory::new()->make(),
            'lines' => [],
    ...
    {
        return PurchaseReceiptDto::class;
    }
}
