...
use Carbon\Carbon;
use Pionect\VismaSdk\Dto\ClaimedByInExpenseReceiptDto;
...
class ClaimedByInExpenseReceiptDtoFactory extends Factory
{
    protected function definition(): array
    {
        return [
            ...
            'contact' => ContactInEmployeeDtoFactory::new()->make(),
            'address' => AddressInEmployeeDtoFactory::new()->make(),
            'lastModifiedDateTime' => Carbon::now()->subDays($this->faker->numberBetween(0, 365)),
            'employeeClass' => EmployeeClassInEmployeeDtoFactory::new()->make(),
    ...
    {
        return ClaimedByInExpenseReceiptDto::class;
    }
}
