...
class FixedAssetDtoFactory extends Factory
{
    protected function definition(): array
    {
        return [
            ...
            'accounts' => AccountsInFixedAssetDtoFactory::new()->make(),
            'details' => DetailsInFixedAssetDtoFactory::new()->make(),
            'bookBalance' => BookBalanceInFixedAssetDtoFactory::new()->make(),
            'location' => LocationInFixedAssetDtoFactory::new()->make(),
            'propertyTax' => PropertyTaxInFixedAssetDtoFactory::new()->make(),
            'type' => TypeInFixedAssetDtoFactory::new()->make(),
