...
class CustomerCreditWriteOffDtoFactory extends Factory
{
    protected function definition(): array
    {
        return [
            ...
            'customerVatZone' => CustomerVatZoneInCustomerCreditWriteOffDtoFactory::new()->make(),
            'timeStamp' => Carbon::now()->subDays($this->faker->numberBetween(0, 365)),
            'customer' => CustomerInCustomerCreditWriteOffDtoFactory::new()->make(),
            ...
            'paymentMethod' => PaymentMethodInCustomerCreditWriteOffDtoFactory::new()->make(),
            ...
            'location' => LocationInCustomerCreditWriteOffDtoFactory::new()->make(),
            'branchNumber' => BranchNumberInCustomerCreditWriteOffDtoFactory::new()->make(),
            'cashAccount' => $this->faker->word(),
            'project' => ProjectInCustomerCreditWriteOffDtoFactory::new()->make(),
            'account' => AccountInCustomerCreditWriteOffDtoFactory::new()->make(),
            'subaccount' => SubaccountInCustomerCreditWriteOffDtoFactory::new()->make(),
