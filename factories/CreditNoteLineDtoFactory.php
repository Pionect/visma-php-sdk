...
use Pionect\VismaSdk\Dto\CreditNoteLineDto;
use Pionect\VismaSdk\Foundation\Factories\Factory;

class CreditNoteLineDtoFactory extends Factory
{
    protected function definition(): array
    {
        return [
            ...
            'account' => AccountInCreditNoteLineDtoFactory::new()->make(),
            'vatCode' => VatCodeInCreditNoteLineDtoFactory::new()->make(),
            'uom' => $this->faker->word(),
            ...
            'subaccount' => SubaccountInCreditNoteLineDtoFactory::new()->make(),
            'salesperson' => $this->faker->word(),
            'seller' => SellerInCreditNoteLineDtoFactory::new()->make(),
            'deferralSchedule' => $this->faker->numberBetween(1, 100),
            'deferralCode' => $this->faker->word(),
            'discountCode' => $this->faker->word(),
            'note' => $this->faker->word(),
            'branchNumber' => BranchNumberInCreditNoteLineDtoFactory::new()->make(),
    ...
    {
        return CreditNoteLineDto::class;
    }
}
