...
class SalesOrderBasicDtoFactory extends Factory
{
    protected function definition(): array
    {
        return [
            ...
            'customer' => CustomerInSalesOrderBasicDtoFactory::new()->make(),
            'contactId' => $this->faker->numberBetween(1, 1000),
            'location' => LocationInSalesOrderBasicDtoFactory::new()->make(),
            ...
            'branchNumber' => BranchNumberInSalesOrderBasicDtoFactory::new()->make(),
