...
class StocktakeLineV2dtoFactory extends Factory
{
    protected function definition(): array
    {
        return [
            ...
            'inventory' => InventoryInStocktakeLineV2DtoFactory::new()->make(),
            'location' => LocationInStocktakeLineV2DtoFactory::new()->make(),
            'warehouse' => WarehouseInStocktakeLineV2DtoFactory::new()->make(),
