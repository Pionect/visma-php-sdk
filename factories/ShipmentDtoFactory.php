...
class ShipmentDtoFactory extends Factory
{
    protected function definition(): array
    {
        return [
            ...
            'customer' => CustomerInShipmentDtoFactory::new()->make(),
            'location' => LocationInShipmentDtoFactory::new()->make(),
            'fromWarehouse' => FromWarehouseInShipmentDtoFactory::new()->make(),
            'toWarehouse' => ToWarehouseInShipmentDtoFactory::new()->make(),
            'currencyId' => $this->faker->uuid(),
            'owner' => OwnerInShipmentDtoFactory::new()->make(),
            ...
            'deliveryAddress' => DeliveryAddressInShipmentDtoFactory::new()->make(),
            'deliveryContact' => DeliveryContactInShipmentDtoFactory::new()->make(),
            'shipVia' => ShipViaInShipmentDtoFactory::new()->make(),
            'fobPoint' => FobPointInShipmentDtoFactory::new()->make(),
            'shippingTerms' => ShippingTermsInShipmentDtoFactory::new()->make(),
            'shippingZone' => ShippingZoneInShipmentDtoFactory::new()->make(),
            ...
            'transactionType' => TransactionTypeInShipmentDtoFactory::new()->make(),
            'modeOfTrasport' => ModeOfTrasportInShipmentDtoFactory::new()->make(),
