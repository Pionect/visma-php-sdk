...
class CustomerDebitNoteDtoFactory extends Factory
{
    ...
    {
        return [
            'creditTerms' => CreditTermsInCustomerDebitNoteDtoFactory::new()->make(),
            ...
            'contact' => ContactInCustomerDebitNoteDtoFactory::new()->make(),
            'attachments' => [],
            'taxDetails' => [],
            'lines' => [],
            'roundingDiff' => $this->faker->randomFloat(2, 0, 1000),
            'customerVatZone' => CustomerVatZoneInCustomerDebitNoteDtoFactory::new()->make(),
            ...
            'salesPerson' => SalesPersonInCustomerDebitNoteDtoFactory::new()->make(),
            'paymentReference' => $this->faker->word(),
            'invoiceAddress' => InvoiceAddressInCustomerDebitNoteDtoFactory::new()->make(),
            'invoiceContact' => InvoiceContactInCustomerDebitNoteDtoFactory::new()->make(),
            'applications' => [],
            'dontPrint' => $this->faker->boolean(),
            'dontEmail' => $this->faker->boolean(),
            'revoked' => $this->faker->boolean(),
            'customer' => CustomerInCustomerDebitNoteDtoFactory::new()->make(),
            ...
            'paymentMethod' => PaymentMethodInCustomerDebitNoteDtoFactory::new()->make(),
            ...
            'location' => LocationInCustomerDebitNoteDtoFactory::new()->make(),
            'branchNumber' => BranchNumberInCustomerDebitNoteDtoFactory::new()->make(),
            'cashAccount' => $this->faker->word(),
            'project' => ProjectInCustomerDebitNoteDtoFactory::new()->make(),
            'account' => AccountInCustomerDebitNoteDtoFactory::new()->make(),
            'subaccount' => SubaccountInCustomerDebitNoteDtoFactory::new()->make(),
    ...
    {
        return CustomerDebitNoteDto::class;
    }
}
