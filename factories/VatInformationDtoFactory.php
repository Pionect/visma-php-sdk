...
class VatInformationDtoFactory extends Factory
{
    protected function definition(): array
    {
        return [
            ...
            'vatAgencyId' => VatAgencyIdInVatInformationDtoFactory::new()->make(),
            'notValidAfter' => Carbon::now()->subDays($this->faker->numberBetween(0, 365)),
            'euReportCode' => $this->faker->word(),
            'documentText' => $this->faker->word(),
            'defaultNonStockItem' => DefaultNonStockItemInVatInformationDtoFactory::new()->make(),
            'vismaXmlVatType' => $this->faker->word(),
            'lastModifiedDateTime' => Carbon::now()->subDays($this->faker->numberBetween(0, 365)),
            'glAccounts' => GlAccountsInVatInformationDtoFactory::new()->make(),
            'schedules' => [],
            'categories' => [],
            'zones' => [],
        ];
