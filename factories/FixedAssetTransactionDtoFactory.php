...
class FixedAssetTransactionDtoFactory extends Factory
{
    protected function definition(): array
    {
        return [
            ...
            'accounts' => AccountsInFixedAssetTransactionDtoFactory::new()->make(),
            'transactionAmount' => $this->faker->randomFloat(2, 0, 1000),
            ...
            'register' => RegisterInFixedAssetTransactionDtoFactory::new()->make(),
