...
class PurchaseReceiptBasicDtoFactory extends Factory
{
    protected function definition(): array
    {
        return [
            ...
            'warehouse' => WarehouseInPurchaseReceiptBasicDtoFactory::new()->make(),
            'supplier' => SupplierInPurchaseReceiptBasicDtoFactory::new()->make(),
            'location' => LocationInPurchaseReceiptBasicDtoFactory::new()->make(),
            ...
            'branchNumber' => BranchNumberInPurchaseReceiptBasicDtoFactory::new()->make(),
            'lines' => [],
