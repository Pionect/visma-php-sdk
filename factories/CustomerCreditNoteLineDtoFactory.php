...
use Carbon\Carbon;
use Pionect\VismaSdk\Dto\CustomerCreditNoteLineDto;
use Pionect\VismaSdk\Foundation\Factories\Factory;

class CustomerCreditNoteLineDtoFactory extends Factory
{
    protected function definition(): array
    {
        return [
            ...
            'account' => AccountInCustomerCreditNoteLineDtoFactory::new()->make(),
            'vatCode' => VatCodeInCustomerCreditNoteLineDtoFactory::new()->make(),
            'uom' => $this->faker->word(),
            ...
            'subaccount' => SubaccountInCustomerCreditNoteLineDtoFactory::new()->make(),
            'salesperson' => $this->faker->word(),
            'seller' => SellerInCustomerCreditNoteLineDtoFactory::new()->make(),
            'deferralSchedule' => $this->faker->numberBetween(1, 100),
            'deferralCode' => $this->faker->word(),
            'discountCode' => $this->faker->word(),
            'note' => $this->faker->word(),
            'branchNumber' => BranchNumberInCustomerCreditNoteLineDtoFactory::new()->make(),
    ...
    {
        return CustomerCreditNoteLineDto::class;
    }
}
